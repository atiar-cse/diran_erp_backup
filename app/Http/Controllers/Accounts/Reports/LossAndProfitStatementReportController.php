...
use App\Exports\Accounts\LossAndProfitExport;
...
class LossAndProfitStatementReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->filled('export')) {
            ...
            if ($file_type=='pdf') {
                ...
                return Excel::download(new LossAndProfitExport( $data['ledgers'] ), 'Profit and Loss.xlsx');
        ...
        return view('accounts.reports.loss_profit_statement');
    }
    ...
    public function exportAsPdf($data)
    {
        ...
        $html = \View::make('accounts.reports.report_pdf.lossAndProfitPDF')->with($data);
        ...
        $mpdf->SetWatermarkText("Profit & Loss Statements");
