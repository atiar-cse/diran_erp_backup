...
class ShappingVoucherController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax()) {
            ...
            $query = DB::table('production_shappings')
                ...
                ->where('production_shappings.approve_status',1)
                ->select(['production_shappings.id AS id',
                    ...
                    'production_shappings.account_status',
        ...
        $chartofAccountList = AccountsChartofAccounts::where('status', '1')
                                        ...
                                        ->get(); 
        return view('accounts.product_section.acc_shapping_voucher',compact('chartofAccountList'));
    }
    ...
    public function show($id)
    {
        try {
            ...
            $jr_data = AccountsJournalEntry::where('transaction_reference_no',"Shapping-$id")->first();
    ...
    private function journalDataEntry($request, $id){
        ...
        $JournalData = [
            ...
            'transaction_reference_no'  => "Shapping-$id",
            'transaction_date'          => dateConvertFormtoDB($request->shapping_date),
            'transaction_type'          => AccountsTransactionType::$ProductionShapping,
            'transaction_type_name'     => AccountsTransactionType::$ProductionShappingTitle,
