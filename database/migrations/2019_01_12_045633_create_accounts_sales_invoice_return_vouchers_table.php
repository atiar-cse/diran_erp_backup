...
class CreateAccountsSalesInvoiceReturnVouchersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('accounts_sales_invoice_return_vouchers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('accounts_sales_invoice_return_vouchers');
    }
}
