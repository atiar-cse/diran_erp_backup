...
class CreateProductionTestingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('production_testings', function (Blueprint $table) {
            $table->increments('id');
            $table->string('testing_no')->unique();
    ...
    {
        Schema::dropIfExists('production_testings');
    }
}
