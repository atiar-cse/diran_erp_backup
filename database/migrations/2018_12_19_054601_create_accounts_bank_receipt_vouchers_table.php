...
class CreateAccountsBankReceiptVouchersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('accounts_bank_receipt_vouchers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('accounts_bank_receipt_vouchers');
    }
}
