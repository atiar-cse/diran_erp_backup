...
class CreateAccountsPurchaseOrderVouchersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('accounts_purchase_order_vouchers', function (Blueprint $table) {
            $table->increments('id');

			$table->string('vouchers_no')->unique();
            $table->integer('purchase_stock_id')->unsigned();
    ...
    {
        Schema::dropIfExists('accounts_purchase_order_vouchers');
    }
}
