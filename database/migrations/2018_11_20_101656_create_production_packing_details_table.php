...
class CreateProductionPackingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('production_packing_details', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('packing_section_id')->unsigned();
            ...
            $table->decimal('current_qty');
            $table->decimal('used_qty',18,2);
            $table->decimal('total_used_qty',18,2);
