...
class CreateAccountsCashPaymentDetailsVouchersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('accounts_cash_payment_details_vouchers', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('cash_payment_id')->unsigned();
    ...
    {
        Schema::dropIfExists('accounts_cash_payment_details_vouchers');
    }
}
