                        ...
                        <div class ="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr>
                                    ...
                                    <th>H.S Code</th>
                                    <th>Landed Unit Price (BDT) <span class="requiredField">*</span></th>
                                ...
                                <tr v-for="(details, index) in form.details">
                                    <td class="width-210">
                                        <select class="form-control m-select2 select2  select-product width-210" v-bind:data-index="index" v-model="details.product_id" style="width:100%" disabled >
                                    ...
                                    <td>
                                        <input type="number" step="any" min="0" v-model="details.unit_price" @input="totalQtyAndPrice()" class="form-control form-control-sm m-input" placeholder="Unit Price" readonly>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button v-if="permissions.indexOf('lc-stock-entry.approve') !=-1" type="submit" class="btn btn-sm btn-success" @click.prevent="update(form.id,1)"><i class="la la-check"></i> <span>Approve</span></button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        props:['permissions','ci_lists','product_lists','measure_unit_lists','warehouse_lists','editId'],
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'lc-stock-entry/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id,approval){
                ...
                axios.put(base_url+'lc-stock-entry/'+id, this.form).then( (response) => {
