<template>
    <div>
        ...
        <AddLcCostNameCategoryEntry></AddLcCostNameCategoryEntry>
    </div>
</template>
...
<script>
    ...
    import AddLcCostNameCategoryEntry from './AddLcCostNameCategoryEntry.vue';
    import VdtnetTable from 'vue-datatables-net';

    export default {
        components: {
            AddLcCostNameCategoryEntry,
            VdtnetTable
        },
        ...
        data: function () {
            return {
                //VdtnetTable Options
                tableId: 'lc-cost-name-category-entry',
                options: {
                    ajax: {
                        url: base_url + "lc-cost-name-category-entry",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    ...
                    cost_category_name: {
                        ...
                        sortable: true,
                        searchable: true/*, defaultOrder: 'asc' */
                    },
                    ...
                    actions: {
                        ...
                        render: (data) => {
                            var htmlButtons = '';
                            if (this.permissions.indexOf('lc-cost-name-category-entry.edit') != -1) {
                            ...
                            if (this.permissions.indexOf('lc-cost-name-category-entry.destroy') != -1) {
            ...
            deleteData(id, tr) {
                ...
                swal({
                    ...
                    function () {
                        ...
                        _this.$loading(true);
                        axios.delete(base_url + 'lc-cost-name-category-entry/' + id)
                            .then((response) => {
                                _this.$loading(false);
