    ...
    <div>
        ...
        <form class="m-form m-form--fit m-form--label-align-right" enctype="multipart/form-data" id="editComponent"
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    <label class="col-lg-2 col-form-label" for="bank_info_display">Bank </label>
                    <div class="col-lg-4">
...
<script>
    ...
    export default {
        ...
        props: ['permissions', 'lc_lists', 'editId'],
        ...
        methods: {
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url + 'lc-cf-value-margin-entry/' + id + '/edit')
                    .then((response) => {
            ...
            update(id, approval) {
                ...
                axios.put(base_url + 'lc-cf-value-margin-entry/' + id, this.form)
                    .then((response) => {
