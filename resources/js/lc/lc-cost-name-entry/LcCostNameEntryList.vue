<template>
    <div>
        ...
        <AddLcCostNameEntry  
            :cost_category_lists="cost_category_lists" 
...
<script>
    ...
    import AddLcCostNameEntry from './AddLcCostNameEntry.vue';
    ...
    export default {
        ...
        props:['permissions','cost_category_lists','account_list'],

        data: function(){
            return {
                //VdtnetTable Options
                tableId: 'lc-cost-name-entry',
                options: {
                    ajax: {
                        url: base_url+"lc-cost-name-entry",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    ...
                    cost_name: { label: 'Cost Name', sortable: true, searchable: true, defaultOrder: 'asc'  },
                    ...
                    actions: {
                        ...
                        render: (data) => {
                            var htmlButtons = '';
                            if (this.permissions.indexOf('lc-cost-name-entry.edit') != -1) {
                            ...
                            if (this.permissions.indexOf('lc-cost-name-entry.destroy') != -1) {
            ...
            deleteData(id,tr){
                ...
                swal({
                    ...
                    function(){
                        ...
                        axios.delete(base_url+'lc-cost-name-entry/'+id).then((response) => {
