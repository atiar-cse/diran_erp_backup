        ...
        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="update(form.id)" id="editComponent" class="m-form m-form--fit m-form--label-align-right"  >
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-md-3">
                        <label for="ci_bank_expenses" class="col-form-label">Bank Expenses</label>
                    ...
                    <div class="col-md-3">
                        <label for="ci_insurance" class="col-form-label">Insurance</label>
                        ...
                        <div class ="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(details, index) in form.details">
                                    ...
                                    <td>
                                        <input type="number" step="any" min="0" v-model="details.qty" @input="totalQtyAndPrice()" class="form-control form-control-sm m-input width-100" placeholder="Quantity">
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button v-if="permissions.indexOf('commercial-invoice-entry.approve') !=-1" type="submit" class="btn btn-sm btn-success" @click.prevent="update(form.id,1)"><i class="la la-check"></i> <span>Approve</span></button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        props:['permissions','lc_lists','cnf_agent_list','product_lists','country_lists','measure_unit_lists','editId'],
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'commercial-invoice-entry/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id,approval){
                ...
                axios.put(base_url+'commercial-invoice-entry/'+id, this.form).then( (response) => {
