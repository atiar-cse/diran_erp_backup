<template>
    <div>
        ...
        <AddLcVoucherType></AddLcVoucherType>
    </div>
</template>
...
<script>
    ...
    import AddLcVoucherType from "./AddLcVoucherType";
    ...
    export default {
        ...
        data: function () {
            return {
                //VdtnetTable Options
                tableId: 'lc-voucher-type',
                options: {
                    ajax: {
                        url: base_url + "lc-voucher-type",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    ...
                    menu_link_db_tbl: {label: 'Menu Link DB Table', sortable: true,},
                    transaction_column: {label: 'TransactionNo Column Name', sortable: true,},
                    narration: {label: 'Narration', sortable: true,},
                    status: {
                    ...
                    actions: {
                        ...
                        render: (data) => {
                            var htmlButtons = '';
                            if (this.permissions.indexOf('lc-voucher-type.edit') != -1) {
                            ...
                            if (this.permissions.indexOf('lc-voucher-type.destroy') != -1) {
            ...
            deleteData(id, tr) {
                ...
                swal({
                    ...
                    function () {
                        ...
                        axios.delete(base_url + 'lc-voucher-type/' + id).then((response) => {
