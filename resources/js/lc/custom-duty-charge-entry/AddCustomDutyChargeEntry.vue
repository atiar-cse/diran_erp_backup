                    ...
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button @click.prevent="store(1)" class="btn btn-sm btn-success"
                                ...
                                class="la la-check"></i><span>Approve</span>
                            </button>
                        </div>
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            store: function (approval) {
                ...
                axios.post(base_url + 'custom-duty-charge-entry', this.form)
                    .then((response) => {
            ...
            loadCommercialInvoicesByLcNo() {
                ...
                axios.get(base_url + "latr-entry/" + id + "/get-commercial-invoices-by-lcno").then((response) => {
                    if (response.data.length > 0) {
                        ...
                        this.ci_lists = {};
                        this.form.lc_commercial_invoice_id = '';
                    }
                });
            },
            ...
            lcNoGenerate() {
                var _this = this;
                axios.get(base_url + 'custom-duty-charge-entry-no-generate')
                    .then((response) => {
                        _this.form.lc_custom_duty_no = response.data;
                    });
            },
        },
        ...
        created() {
            ...
            _this.form.custom_duty_date = moment().format('DD/MM/YYYY');
        }
    }
</script>
