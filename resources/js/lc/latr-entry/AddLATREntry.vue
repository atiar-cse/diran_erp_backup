                            ...
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tbody>
                                    <tr v-for="(details, index) in form.details">
                                        ...
                                        <td class="width-210">
                                            <select class="form-control m-select2 select2  select-product width-210" v-bind:data-index="index" v-model="details.product_id" style="width:170px" >
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            <input type="number" v-model="form.bank_percentage" class="form-control form-control-sm m-input" placeholder="Bank interest" >
                                        </td>
                                        <td>Bank Interest Amount  </td>
                                        <td  class="">
                                            <input type="number" v-model="form.bank_percentage_amount" class="form-control form-control-sm m-input text-right" placeholder="Bank Interest Amount"  >
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"> <span class="requiredField">*</span> LATR Amount = </td>
                                        <td  class="">
    ...
    export default {
        ...
        methods: {
            ...
            store: function (approval) {
                ...
                axios.post(base_url + 'latr-entry', this.form).then((response) => {
        ...
        created() {
            var _this = this;
            _this.totalQtyAndPrice();
            _this.form.latr_date = moment().format('DD/MM/YYYY');
        }
