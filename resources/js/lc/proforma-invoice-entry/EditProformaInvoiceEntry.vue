            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-md-4">
                        ...
                        <input type="text"  id="pi_no"  v-model="form.pi_no" class="form-control form-control-sm m-input" placeholder="Enter Proforma Invoice No" >
                        <div class="requiredField" v-if="(errors.hasOwnProperty('pi_no'))">{{ (errors.hasOwnProperty('pi_no')) ? errors.pi_no[0] :'' }}</div>
                    </div>
                    <div class="col-md-4">
                        <label for="work_order_id">Work Order No <span class="requiredField">*</span></label>
                        <select class="form-control m-select2 select2  select-work-order" id="work_order_id" data-selectField="work_order_id" v-model="form.work_order_id" >
                ...
                <div class="form-group m-form__group row">                    
                    <div class="col-md-4">
                        ...
                        <div class="input-group date">
                            <input type="text" class="form-control form-control-sm m-input datepicker" v-model="form.pi_date" data-dateField="pi_date" readonly placeholder="Select date from picker" id="pi_date" />
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text"  id="usd_account_no"  v-model="form.usd_account_no" class="form-control form-control-sm m-input" placeholder="Enter USD A/C  No">
                        <div class="requiredField" v-if="(errors.hasOwnProperty('usd_account_no'))">{{ (errors.hasOwnProperty('usd_account_no')) ? errors.usd_account_no[0] :'' }}</div>
                    </div>                    
                    <div class="col-md-4">
                        <label for="consignee">Consignee </label>
                        <input type="text"  id="consignee"  v-model="form.consignee" class="form-control form-control-sm m-input" placeholder="Enter Consignee Name">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    <div class="col-md-4">
                        ...
                        <input type="text"  id="swift_code"  v-model="form.swift_code" class="form-control form-control-sm m-input" placeholder="Enter Swift Code">
                    </div>                    
                    <div class="col-md-4">
                        <label for="terms_of_loading">Terms Of Loading <span class="requiredField">*</span></label>
                        <div class="input-group date">
                            <input type="text"  id="terms_of_loading"  v-model="form.terms_of_loading" class="form-control form-control-sm m-input" placeholder="Enter Terms Of Loading">
                        </div>
                        <div class="requiredField" v-if="(errors.hasOwnProperty('terms_of_loading'))">{{ (errors.hasOwnProperty('terms_of_loading')) ? errors.terms_of_loading[0] :'' }}</div>
                    </div>
                    <div class="col-md-4">
                        <label for="port_of_discharger">Port of Discharge <span class="requiredField">*</span></label>
                        <input type="text"  id="port_of_discharger"  v-model="form.port_of_discharger" class="form-control form-control-sm m-input" placeholder="Enter Port of Discharge">
                        <div class="requiredField" v-if="(errors.hasOwnProperty('port_of_discharger'))">{{ (errors.hasOwnProperty('port_of_discharger')) ? errors.port_of_discharger[0] :'' }}</div>
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    <div class="col-md-4">
                        ...
                        <div class="input-group date">
                            <input type="text" class="form-control form-control-sm m-input datepicker" v-model="form.delivery_time" data-dateField="delivery_time" readonly placeholder="Select date from picker" id="delivery_time" />
                            <div class="input-group-append">
                                <span class="input-group-text">
                                    <i class="la la-calendar-check-o"></i>
                                </span>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group date">
                            <input type="text"  id="terms_of_delivery"  v-model="form.terms_of_delivery" class="form-control form-control-sm m-input" placeholder="Enter Terms Of Delivery">
                        </div>
                        <div class="requiredField" v-if="(errors.hasOwnProperty('terms_of_delivery'))">{{ (errors.hasOwnProperty('terms_of_delivery')) ? errors.terms_of_delivery[0] :'' }}</div>
                    </div>
                    <div class="col-md-4">
                        <label for="terms_of_payment">Terms of Payment </label>
                        <input type="text"  id="terms_of_payment"  v-model="form.terms_of_payment" class="form-control form-control-sm m-input" placeholder="Enter Terms of Payment">
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    <div class="col-md-4">
                        ...
                        <select class="form-control m-select2 select2  select-country" id="origin_of_goods" data-selectField="origin_of_goods" v-model="form.origin_of_goods" >
                            <option v-for="(svalue,sindex) in cuountry_lists" :value="svalue.id" > {{svalue.country_name}}</option>
                        </select>
                    </div>                    
                    <div class="col-md-4">
                        <label for="final_destination">Final Destination </label>
                        <input type="text"  id="final_destination"  v-model="form.final_destination" class="form-control form-control-sm m-input" placeholder="Enter Final Destination">
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class ="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(details, index) in form.details">
                                    ...
                                    <td>
                                        <input type="text" v-model="details.total_price" class="form-control form-control-sm m-input" placeholder="" readonly>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" v-model="details.unit_price_bdt" class="form-control form-control-sm m-input" readonly>
                                    </td>

                                    <td class="width-160">
                                        <input type="text" v-model="details.total_amount_taka" class="form-control form-control-sm m-input width-160" readonly>
                                    </td>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button v-if="permissions.indexOf('proforma-invoice-entry.approve') !=-1" type="submit" class="btn btn-sm btn-success"  @click.prevent="update(form.id,1)"><i class="la la-check"></i> <span>Approve</span></button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        props:['permissions','work_order_lists','product_lists','currency_lists','cuountry_lists','editId'],
        ...
        methods:{
            ...
            loadDetails(){
                var _this = this;
                var id= this.form.work_order_id;

                axios.get(base_url+"work-order-import/"+id+"/lc-product-list").then((response) => {
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'proforma-invoice-entry/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id, app){
                ...
                axios.put(base_url+'proforma-invoice-entry/'+id, this.form).then( (response) => {
            ...
            totalQtyAndPriceAndRate(){
                ...
                for(let i = 0; i < length; i++) {
                    ...
                    if (get_unit_price_bdt>0) {
                        this.form.details[i].unit_price_bdt = total_amount_taka / Number(details[i].qty);
                    }                    
        ...
        mounted(){
            ...
            $('#editComponent').on('change', '.select-work-order', function (e) {
            ...
            $('#editComponent').on('change', '.select-country', function (e) {
                var selectedItem = $(this),
                    curerntVal = !!selectedItem.val(),
                    dataIndex = $(e.currentTarget).attr('data-index');
            ...
            $('#editComponent').on('change', '.select-currency', function (e) {
                var selectedItem = $(this),
                    curerntVal = !!selectedItem.val(),
                    dataIndex = $(e.currentTarget).attr('data-index');
