        ...
        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="update(form.id)" id="editComponent" class="m-form m-form--fit m-form--label-align-right"  >
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <label for="coa_id" class="col-lg-2 col-form-label">Supplier/ Exporter</label>
                    <div class="col-lg-4">
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button v-if="permissions.indexOf('work-order-import.approve') !=-1" type="submit" class="btn btn-sm btn-success" @click.prevent="update(form.id,1)"><i class="la la-check"></i> <span>Approve</span></button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        props:['permissions','product_lists','supplier_lists','currency_lists','editId','coa_lists'],
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'work-order-import/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id,approval){
                ...
                axios.put(base_url+'work-order-import/'+id, this.form).then( (response) => {
        ...
        mounted(){
            ...
            $('#editComponent').on('change', '.select-coa', function (e) {
                var selectedItem = $(this),
                    curerntVal = !!selectedItem.val(),
                    dataIndex = $(e.currentTarget).attr('data-index');
