<template>
    <div>
        ...
        <AddBillPaymentVoucher v-else-if="add_form" :product_lists="product_lists" :po_order_generate="po_order_generate" :supplier_lists="supplier_lists" :requisition_lists="requisition_lists"></AddBillPaymentVoucher>
        <!--<EditPurchaseReceive v-else-if="edit_form" :product_lists="product_lists" :edit-id="edit_id" :supplier_lists="supplier_lists" :requisition_lists="requisition_lists"></EditPurchaseReceive>-->
...
<script>
    ...
    import AddBillPaymentVoucher from './AddBillPaymentVoucher.vue';
    //import EditPurchaseReceive from './EditPurchaseReceive.vue';


    export default {
        components: {
            AddBillPaymentVoucher,
            //EditPurchaseReceive,
            Pagination
        },
        ...
        methods: {
            index(pageNo,perPage){
                ...
                axios.get(base_url+"po-receive/?page="+pageNo+"&perPage="+perPage).then((response) => {
            ...
            deleteData(id){
                ...
                swal({
                    ...
                    function(){
                        ...
                        axios.delete(base_url+'po-receive/'+id+'/delete').then((response) => {
                            _this.index(1);
