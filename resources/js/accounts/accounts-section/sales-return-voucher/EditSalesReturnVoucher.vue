        ...
        <form method="POST"  enctype="multipart/form-data" v-on:submit.prevent="update(form.id)" id="editComponent" class="m-form m-form--fit m-form--label-align-right" >
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <label for="sales_return_id" class="col-lg-2 col-form-label">Purchase Stock </label>
                    <div class="col-lg-4">
                        <select class="form-control m-select2 select2" data-selectField="sales_return_id" id="sales_return_id" v-model="form.sales_return_id" disabled="disabled">
                            <option v-for="(rvalue,rindex) in rtn_lists" :value="rvalue.id" > {{rvalue.sales_delivery_return_no}}</option>
                        </select>
                    </div>
                </div>

                <div class="form-group m-form__group row">
                    <label for="sales_return_date" class="col-lg-2 col-form-label"> Date </label>
                    <div class="col-lg-4">
                        <input type="text"  id="sales_return_date"  v-model="form.sales_return_date" class="form-control form-control-sm m-input disabled" disabled="disabled">
                    </div>
                    ...
                    <div class="col-lg-4">
                        <select class="form-control m-select2 select2" data-selectField="customer_id" id="customer_id" v-model="form.customer_id" disabled="disabled">
                            <option v-for="(cvalue,cindex) in customer_lists" :value="cvalue.id" > {{cvalue.sales_customer_name}} ({{cvalue.sales_customer_id}})</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button v-if="permission.indexOf('sales-return-voucher.approve') != -1" type="submit" class="btn btn-sm btn-success" @click.prevent="update(form.id,1)"  ><i class="la la-check"></i> <span>Approve</span></button>
...
<script>
    ...
    export default {
        ...
        props:['permission','editId','pid_lists','rtn_lists',
            'customer_lists','bank_wise_account_list',
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'sales-return-voucher/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id,app){
                ...
                axios.put(base_url+'sales-return-voucher/'+id,
