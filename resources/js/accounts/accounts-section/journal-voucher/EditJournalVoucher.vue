                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4">
                        <input class="form-control form-control-sm m-input" id="transaction_reference_no"
                               placeholder="Enter Transaction No" type="text"
                               v-model="form.transaction_reference_no">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(details, index) in form.details">
                                    ...
                                    <td>
                                        <input class="form-control form-control-sm m-input width-100" type="text"
                                    ...
                                    <td v-if="is_lc_type==true">
                                        ...
                                        <div class="requiredField" v-if="errors['details.'+index+'.voucher_type_id']">{{
                                            errors['details.'+index+'.voucher_type_id'][0] }}
                                        </div>
                                    </td>
                                    <td v-if="is_lc_type==true">
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            <button @click.prevent="update(form.id,1)" class="btn btn-sm btn-primary"
                                    id="approve"
...
<script>
    ...
    export default {
        ...
        props: ['permissions', 'cost_center_list', 'account_list', 'editId', 'branch_list'],
        ...
        methods: {
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url + 'journal-voucher/' + id + '/edit')
                    .then((response) => {
            ...
            update(id, app) {
                ...
                axios.put(base_url + 'journal-voucher/' + id, this.form)
                    .then((response) => {
