        ...
        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="update(form.id)" id="editComponent" class="m-form m-form--fit m-form--label-align-right" >
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <label for="bank_transfer_date" class="col-lg-2 col-form-label">Bank Transfer Date <span class="requiredField">*</span></label>
                    <div class="col-lg-4">
                ...
                <div v-show="form.payment_method == 2 || form.payment_method == 3 || form.payment_method == 4">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4">
                            <!--<input type="text"  v-model="form.account_no" id="account_no" class="form-control form-control-sm m-input" placeholder="Enter Account No">-->
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            <button type="submit" id="approve" v-if="permissions.indexOf('bank-transfer-deposits.approve') != -1" @click.prevent="update(form.id,1)" class="btn btn-sm btn-primary"><i class="la la-check"></i> <span>Approve</span></button>
...
<script>
    ...
    export default {
        ...
        props:['permissions','bank_wise_account_list','account_list','bank_list','editId','branch_list'],
        ...
        methods:{
            ...
            edit(id) {
                ...
                axios.get(base_url+'bank-transfer-deposit/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id,app){
                ...
                axios.put(base_url+'bank-transfer-deposit/'+id, this.form).then( (response) => {
            ...
            loadBankAcctList(){
                var _this = this;
                axios.get(base_url+"bank-wise-account-no?bank_id=" + this.form.bank_id).then((response) => {
