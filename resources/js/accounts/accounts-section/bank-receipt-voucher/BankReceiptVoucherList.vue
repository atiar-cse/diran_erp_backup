...
<script>
    ...
    import AddBankReceiptVoucher from './AddBankReceiptVoucher.vue';
    import EditBankReceiptVoucher from './EditBankReceiptVoucher.vue';
    import ViewBankReceiptVoucher from './ViewBankReceiptVoucher.vue';
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                //VdtnetTable Options
                tableId: 'bank-receipt-voucher',
                options: {
                    ajax: {
                        url: base_url + "bank-receipt-voucher",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    ...
                    reciept_date: {label: 'Receipt Date', sortable: true, searchable: true},
                    ...
                    actions: {
                        ...
                        render: (data, type, row, meta) => {
                            var htmlButtons = '';
                            if (this.permissions.indexOf('bank-receipt-voucher.edit') != -1 && row.approve_status != 1) {
                            ...
                            if (this.permissions.indexOf('bank-receipt-voucher.destroy') != -1 && row.approve_status != 1) {
                            ...
                            if (this.permissions.indexOf('bank-receipt-voucher.show') != -1) {
                            ...
                            if ((this.permissions.indexOf('super-admin') != -1 || this.permissions.indexOf('bank-receipt-voucher.unapprove') != -1) && row.approve_status ==1 ) {
        ...
        methods: {
            ...
            deleteData(id, tr) {
                ...
                swal({
                    ...
                    function () {
                        ...
                        _this.$loading(true);
                        axios.delete(base_url + 'bank-receipt-voucher/' + id)
                            .then((response) => {
                                _this.$loading(false);
            ...
            doSuperAdmin(data){ //Unapprove
                ...
                swal({
                    ...
                    function(){
                        axios.get(base_url+'bank-receipt-voucher/'+id+'?isSuperAdmin=unapprove').then((response) => {
