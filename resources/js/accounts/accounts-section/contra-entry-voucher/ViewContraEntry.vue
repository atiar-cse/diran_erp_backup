                                        ...
                                        <div class="m-invoice__container m-invoice__container--centered">
                                            ...
                                            <div class="m-invoice__items" style="margin-top:-50px;">
                                                <div class="m-invoice__item ">
                                                    <span class="m-invoice__subtitle text-center">Contra Voucher</span>
                                                </div>
                                            </div>

                                            <div class="m-invoice__items" style="margin-top:-100px;">
                                                <div class="m-invoice__item ">
                                                    <span class="m-invoice__subtitle">Voucher No : <span>{{form.contra_entry_no}}</span></span><br>
                                                    ...
                                                    <div
                                                        v-show="form.payment_method == 2 || form.payment_method == 3 || form.payment_method == 4">
                                                    ...
                                                    <div v-show="form.payment_method == 5">
                                                        <span class="m-invoice__text"><b>Paied By: </b>&nbsp;&nbsp; Account Transfer</span><br/>
                                                    </div>
                                                </div>
                                                <div class="m-invoice__item">
                                                    <span class="m-invoice__subtitle text-right">Date :<span>{{form.contra_date}}   </span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tr v-for="(details, index) in form.get_details">
                                                    <td>{{++index}}</td>
                                                    <td class="text-left">{{details.coa ?
                                                        details.coa.chart_of_account_code:''}}
                                                    </td>
                                                    <td class="text-left">{{details.coa ?
                                                        details.coa.chart_of_accounts_title:''}}
                                                    </td>
                                                    <td class="text-left" v-if="form.is_lc_type==true">
                                                        {{details.voucher_type ? details.voucher_type: ''}}
                                                    </td>
                                                    <td class="text-left" v-if="form.is_lc_type==true">
                                                        {{ details.voucher_ref ? details.voucher_ref: ''}}
                                                    </td>
...
<script>
    export default {
        ...
        methods: {
            ...
            show(id) {
                var _this = this;
                axios.get(base_url + 'contra-entry-voucher/' + id)
                    .then((response) => {
