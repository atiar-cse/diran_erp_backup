    ...
    <div>
        ...
        <form class="m-form m-form--fit m-form--label-align-right" id="addComponent" method="POST"
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    <label for="type" class="col-lg-2 col-form-label">Type sss</label>
                    <div class="col-lg-4">
                        <select class="form-control m-select2 select2" data-selectField="type" id="type"
                                v-model="form.type">
                            <option value="No Seection">No Seection</option>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button @click.prevent="store(0)" class="btn btn-sm btn-success" type="submit" id="submit"><i
    ...
    export default {
        ...
        methods: {
            transactionNoGenerate() {
                var _this = this;
                axios.get(base_url + 'contra-transaction-no')
                    .then((response) => {
                        _this.form.contra_entry_no = response.data;
                        if (_this.type == 'lc') {
                            _this.form.is_lc_type = true;
                        } else {
                            _this.form.is_lc_type = false;
                        }
                    });
            },
            ...
            store(app) {
                ...
                axios.post(base_url + 'contra-entry-voucher', _this.form)
                    .then((response) => {
            ...
            loadBankAcctList() {
                ...
                axios.get(base_url + "bank-wise-account-no?bank_id=" + this.form.bank_id).then((response) => {
                    if (response.data.length > 0) {
                        _this.bank_wise_account_list = response.data;
                    }
                });
            },
