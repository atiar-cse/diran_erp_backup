                                        ...
                                        <div class="m-invoice__container m-invoice__container--centered">
                                            ...
                                            <div class="m-invoice__items" style="margin-top:-50px;">
                                                <div class="m-invoice__item ">
                                                    <span
                                                        class="m-invoice__subtitle text-center">Purchase Order Voucher</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="m-invoice__items" style="margin-top:-100px;">
                                                ...
                                                <div class="m-invoice__item">
                                                    <span class="m-invoice__subtitle text-right">Date :<span>{{form.purchase_date}}   </span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            show(id) {
                var _this = this;
                _this.$loading(true);
                axios.get(base_url + 'purchase-invoice-voucher/' + id)
                    .then((response) => {
                        _this.$loading(false);
