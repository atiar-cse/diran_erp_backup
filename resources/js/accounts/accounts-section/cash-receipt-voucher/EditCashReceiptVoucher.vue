        ...
        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="update(form.id)" id="editComponent"
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    <label for="receipt_transaction_no" class="col-lg-2 col-form-label">Receipt No <span
                        class="requiredField">*</span></label>
                    <div class="col-lg-4">
                        <input type="text" id="receipt_transaction_no" v-model="form.receipt_transaction_no"
                               class="form-control form-control-sm m-input" placeholder="Enter Reciept Transaction No">
                    ...
                    <label for="receipt_date" class="col-lg-2 col-form-label">Receipt Date <span
                        class="requiredField">*</span></label>
                    <div class="col-lg-4">
                        <div class="input-group date">
                            <input type="text" class="form-control form-control-sm m-input datepicker"
                                   v-model="form.receipt_date" data-dateField="receipt_date" readonly
                                   placeholder="Select date from picker" id="receipt_date"/>
                        ...
                        <div class="requiredField" v-if="(errors.hasOwnProperty('receipt_date'))">{{
                            (errors.hasOwnProperty('receipt_date')) ? errors.receipt_date[0] :'' }}
                        </div>
                    </div>
                </div>

                <!--<div class="form-group m-form__group row">
                    <label for="cost_center_id" class="col-lg-2 col-form-label">Cost Center </label>
                    <div class="col-lg-4">
                        <select class="form-control m-select2 select2" id="cost_center_id" data-selectField="cost_center_id" v-model="form.cost_center_id" >
                            <option v-for="(value,index) in cost_center_list" :value="value.id"> {{value.cost_center_name}}</option>
                            <div class="requiredField" v-if="(errors.hasOwnProperty('cost_center_id'))">{{ (errors.hasOwnProperty('cost_center_id')) ? errors.cost_center_id[0] :'' }}</div>
                        </select>
                    </div>
                    <label for="branch_id" class="col-lg-2 col-form-label">Branch </label>
                    <div class="col-lg-4">
                        <select class="form-control m-select2 select2" data-selectField="branch_id" id="branch_id" v-model="form.branch_id" >
                            <option v-for="(value,index) in branch_list" :value="value.id"> {{value.branch_name}}</option>
                        </select>
                        <div class="requiredField" v-if="(errors.hasOwnProperty('branch_id'))">{{ (errors.hasOwnProperty('branch_id')) ? errors.branch_id[0] :'' }}</div>
                    </div>
                </div>
                -->
                <div class="form-group m-form__group row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(debit_details, index) in form.debit_details"
                                    ...
                                    <td>
                                        <input type="text" id="remarks" v-model="debit_details.remarks"
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input type="number" readonly step="any"
                                                   class="form-control form-control-sm m-input text-right width-200"
                                                   v-model="debit_details.debit_amount" @input="calculation()"/>
                                        </div>
                                        <div class="requiredField"
                                    ...
                                    <!--<td>
                                        <a  @click="removeDebitAccount(index,debit_details.id)" class="btn btn-outline-danger m-btn m-btn&#45;&#45;icon m-btn&#45;&#45;icon-only m-btn&#45;&#45;pill m-btn&#45;&#45;air" data-offset="-20px -20px" data-toggle="m-tooltip" data-placement="top" title="Delete"><i class="la la-trash-o"></i></a>
                                    </td>-->
                                </tr>
                                <tr>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr>
                                    ...
                                    <th width="8%">{{type_name_title}}</th>
                                    <th width="12%">Money Rcpt No</th>
                                ...
                                <tr v-for="(credit_details, index) in form.credit_details"
                                    ...
                                    <!--<td>
                                        <select class="form-control m-select2 select2 select-credit-account " v-bind:data-index="index" v-model="credit_details.credit_account_id" style="min-width: 200px;"  >
                                    ...
                                    <td width="20%">
                                        <select class="form-control m-select2 select2  select-credit-account"
                                                ...
                                                style="width: 100%">
                                            <option v-for="(value,index) in credit_details.sb2_wise_coa_lists"
                                    ...
                                    <td width="8%">
                                        <div class="input-group">
                                            <input type="text" class="form-control form-control-sm m-input width-120"
                                                   v-model="credit_details.remarks"/>
                                        </div>
                                    ...
                                    <td width="12%">
                                        <div class="input-group">
                                            <input type="text" class="form-control form-control-sm m-input width-120 "
                                                   v-model="credit_details.money_receipt_no"/>
                                        </div>
                                        <div class="requiredField"
                                             v-if="errors['credit_details.'+index+'.money_receipt_no']">{{
                                            errors['credit_details.'+index+'.money_receipt_no'][0] }}
                                        </div>
                                    </td>
                                    <td width="22%">
                                        <div class="input-group">
                                            <input type="number" step="any"
                                                   class="form-control form-control-sm m-input text-right width-150 "
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            <button type="submit" id="approve" v-if="permissions.indexOf('cash-receipt-vouchers.approve') != -1"
...
<script>
    ...
    export default {
        ...
        props: ['permissions', 'cost_center_list', 'account_list', 'editId', 'branch_list', 'subcode2_list'],
        ...
        methods: {
            ...
            edit(id) {
                var _this = this;
                _this.$loading(true);
                axios.get(base_url + 'cash-receipt-voucher/' + id + '/edit')
                    .then((response) => {
                        _this.$loading(false);
            ...
            update(id, app) {
                ...
                _this.$loading(true);
                axios.put(base_url + 'cash-receipt-voucher/' + id, _this.form)
                    .then((response) => {
                ...
                axios.get(base_url + "sbc2-wise-coa/" + sub_code2_id)
                    .then((response) => {
                        ...
                        if (response.data.length > 0) {
                            _this.form.credit_details[acctIndex2].sb2_wise_coa_lists = response.data;
            ...
            calculation() {
                ...
                _this.form.debit_details[0].debit_amount = totalCredit;
            ...
            $(document).on("focus", ".datepicker", function () {
                $(this).datepicker({
                    ...
                    if (ev.date == undefined) {
                        _this.form.receipt_date = '';
                    } else {
                        _this.form.receipt_date = moment(ev.date).format('DD/MM/YYYY');
                    }
                });
            });
        },
