                        ...
                        <div class="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr>
                                    ...
                                    <th width="10%">Money Reciept No</th>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            <button id="approve" type="submit" v-if="permissions.indexOf('cash-receipt-vouchers.approve') != -1"
                                    class="btn btn-sm btn-primary" @click.prevent="store(1)"><i class="la la-check"></i>
                                <span>Approve</span></button>
                            <button type="submit" class="btn btn-sm btn-success" id="submit" @click.prevent="store(0)">
    ...
    export default {
        ...
        methods: {
            ...
            transactionNoGenerate() {
                var _this = this;
                axios.get(base_url + 'cash-receipt-no')
                    .then((response) => {
            ...
            store(app) {
                ...
                axios.post(base_url + 'cash-receipt-voucher', this.form).then((response) => {
