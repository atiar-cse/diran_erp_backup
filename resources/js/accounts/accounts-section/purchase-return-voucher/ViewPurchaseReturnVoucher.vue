                                        ...
                                        <div class="m-invoice__container m-invoice__container--centered">
                                            ...
                                            <div class="m-invoice__items" style="margin-top:-50px;">
                                                <div class="m-invoice__item ">
                                                    <span class="m-invoice__subtitle text-center">Purchase Return Voucher</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="m-invoice__items" style="margin-top:-100px;">
                                                <div class="m-invoice__item ">
                                                    ...
                                                    <div
                                                        v-show="form.payment_type == 2 || form.payment_type == 3 || form.payment_type == 4">
                                                ...
                                                <div class="m-invoice__item">
                                                    <span class="m-invoice__subtitle text-right">Date :<span>{{form.purchase_return_date}}   </span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tr v-for="(details, index) in form.get_details">
                                                    <td>{{++index}}</td>
                                                    <td class="text-left">
                                                        {{details.coa?details.coa.chart_of_account_code:''}}
                                                    </td>
                                                    <td class="text-left">
                                                        {{details.coa?details.coa.chart_of_accounts_title:''}}
                                                    </td>
...
<script>
    export default {
        ...
        data: function () {
            return {
                purchase_invoice_return_voucher_list: false,
                add_form: false,
                edit_form: false,
                view_form: true,
        ...
        methods: {
            ...
            show(id) {
                var _this = this;
                _this.$loading(true);
                axios.get(base_url + 'purchase-return-voucher/' + id)
                    .then((response) => {
                        _this.$loading(false);
            ...
            calculateTotalDebitCredit() {
                ...
                var details = this.form.get_details;
