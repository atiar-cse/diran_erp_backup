        ...
        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="update(form.id)" id="editComponent" class="m-form m-form--fit m-form--label-align-right" >
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <label for="purchase_return_id" class="col-lg-2 col-form-label">Purchase Return </label>
                    <div class="col-lg-4">
                        <select class="form-control m-select2 select2" data-selectField="purchase_return_id" id="purchase_return_id" v-model="form.purchase_return_id" disabled="disabled">
                            <option v-for="(rvalue,rindex) in rtn_lists" :value="rvalue.id" > {{rvalue.po_return_no}}</option>
                        </select>
                    </div>
                </div>

                <div class="form-group m-form__group row">
                    <label for="purchase_return_date" class="col-lg-2 col-form-label"> Date </label>
                    <div class="col-lg-4">
                        <input type="text"  id="purchase_return_date"  v-model="form.purchase_return_date" class="form-control form-control-sm m-input disabled" disabled="disabled">
                    </div>
                    <label for="supplier_id" class="col-lg-2 col-form-label">Supplier</label>
                    <div class="col-lg-4">
                        <select class="form-control m-select2 select2" data-selectField="supplier_id" id="supplier_id" v-model="form.supplier_id" disabled="disabled">
                            <option v-for="(svalue,sindex) in supplier_lists" :value="svalue.id" > {{svalue.purchase_supplier_name}} ({{svalue.purchase_supplier_id}})</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    <!-- <label for="cost_center_id" class="col-lg-2 col-form-label">Cost Centre </label>
                    <div class="col-lg-4">
                        <select class="form-control m-select2 select2" data-selectField="cost_center_id" id="cost_center_id" v-model="form.cost_center_id" >
                            <option v-for="(value,index) in bank_wise_account_list" :value="value.id"> {{value.cost_center_name}}</option>
                        </select>
                        <div class="requiredField" v-if="errors['cost_center_id']">{{ errors['cost_center_id'][0] }}</div>
                    </div> -->
                ...
                <div v-show="form.payment_type == 2 || form.payment_type == 3 || form.payment_type == 4">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <!--<label class="col-lg-2 col-form-label" for="cheque_book">Cheque Book </label>
                        <div class="col-lg-4">
                            <input type="text" id="cheque_book" v-model="form.cheque_book" class="form-control form-control-sm m-input" placeholder="Enter Cheque Book">
                            <div class="requiredField" v-if="(errors.hasOwnProperty('cheque_book'))">{{ (errors.hasOwnProperty('cheque_book')) ? errors.cheque_book[0] :'' }}</div>
                        </div>-->
                    </div>
                        ...
                        <div class ="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" v-model="form.total_price" class="form-control form-control-sm m-input" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td >
                                        <input type="text" v-model="form.price_paid" class="form-control form-control-sm m-input">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td >
                                        <input type="text" v-model="form.price_due" class="form-control form-control-sm m-input">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button v-if="permission.indexOf('purchase-return-voucher.approve') != -1" type="submit" class="btn btn-sm btn-success" @click.prevent="update(form.id,1)"  ><i class="la la-check"></i> <span>Approve</span></button>
...
<script>
    ...
    export default {
        ...
        props:['permission','editId','pid_lists',
            'rtn_lists', 'supplier_lists','bank_wise_account_list',
        ...
        methods:{
            edit(id) {
                var _this = this;
                axios.get(base_url+'purchase-return-voucher/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id,app){
                ...
                axios.put(base_url+'purchase-return-voucher/'+id, this.form).then( (response) => {
            ...
            loadBankAcctList(){
                var _this = this;
                axios.get(base_url+"purchase-retn-bank-wise-account-number?bank_id=" + this.form.bank_id).then((response) => {
