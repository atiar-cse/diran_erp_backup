                    ...
                    <div class="col-lg-12" >
                        <div class="row justify-content-md-center">
                            ...
                            <div class="col-lg-3">
                                ...
                                <select class="form-control m-select3 select2" data-selectField="sales_invoices_customer_id" id="sales_invoices_customer_id" v-model="form.sales_invoices_customer_id" >
