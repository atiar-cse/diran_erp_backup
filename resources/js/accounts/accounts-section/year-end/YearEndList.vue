<template>
    <div>
        ...
        <AddYearEnd  v-else-if="add_form" :brand_list="brand_list" :category_list="category_list" :measure_unit_list="measure_unit_list" :country_list="country_list"></AddYearEnd>
        <!--<EditContraEntryVoucher  v-else-if="edit_form" :brand_list="brand_list" :category_list="category_list" :measure_unit_list="measure_unit_list" :country_list="country_list" :edit-id="edit_id"></EditContraEntryVoucher>-->
...
<script>
    ...
    import AddYearEnd from './AddYearEnd.vue';
