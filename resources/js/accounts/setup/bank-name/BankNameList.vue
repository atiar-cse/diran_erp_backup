...
<script>
    ...
    import AddBankName from './AddBankName.vue';
    ...
    export default {
        ...
        data: function(){
            return {
                ...
                fields: {
                    id: { label: 'ID'},
                    accounts_bank_names: { label: 'Bank Name', sortable: true, searchable: true  },
                    accounts_bank_codes: { label: 'Bank Code' ,sortable: true, searchable: true},
                    accounts_bank_address: { label: 'Bank Address',sortable: false, searchable: false },
                    'accounts_bank_names.created_by': { label: 'User', template: '<span v-if="row.ad_name">Added By : {{ row.ad_name }}</span><br><span v-if="row.ed_name">Edited By  : {{ row.ed_name }}</span>', sortable: false, searchable: false },
                    status: {
                    ...
                    actions: {
                        ...
                        render: (data) => {
                            var htmlButtons = '';
                            if (this.permissions.indexOf('bank.edit') != -1) {
                            ...
                            if (this.permissions.indexOf('bank.destroy') != -1) {
            ...
            deleteData(id,tr){
                ...
                swal({
                    ...
                    function(){
                        ...
                        axios.delete(base_url+'bank/'+id+'/delete').then((response) => {
