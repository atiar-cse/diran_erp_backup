    ...
    export default {
        ...
        data: function(){
            return {
                ...
                fields: {
                    id: { label: 'ID'},
                    project_name: { label: 'Project Name', sortable: true, searchable: true},
                    remarks: { label: 'Remarks', sortable: false, searchable: false  },
                    'accounts_project_infos.created_by': { label: 'User', template: '<span v-if="row.ad_name">Added By : {{ row.ad_name }}</span><br><span v-if="row.ed_name">Edited By  : {{ row.ed_name }}</span>', sortable: false, searchable: false },
                    actions: {
                        isLocal: true,
                        label: 'Actions',
                        render: (data,type,row,meta) => {
                            ...
                            if (this.permissions.indexOf('project-info.edit') != -1 ) {
                            ...
                            if (this.permissions.indexOf('project-info.destroy') != -1) {
            ...
            deleteData(id,tr){
                ...
                swal({
                    ...
                    function(){
                        ...
                        axios.delete(base_url+'project-info/'+id).then((response) => {
                            //_this.index(1);
