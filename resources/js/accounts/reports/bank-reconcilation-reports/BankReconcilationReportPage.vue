<template>
    <div>
        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="report" id="listComponent"
                            ...
                            <div class="col-md-4">
                                <div class="m-form__group m-form__group">
                                    ...
                                    <div class="m-form__control">
                                        <select class="form-control m-select2 select2" id="account_id"
                                                data-selectField="account_id" v-model="form.account_id">
                                            <option v-for="(avalue,aindex) in account_lists" :value="avalue.id"> {{
                                                avalue.chart_of_accounts_title +'('+ avalue.chart_of_account_code +')'}}
                                            </option>
                                        </select>
                                    </div>
                                </div>
        ...
        <div class="m-portlet__body" v-if="bank_reconsile_list">
                ...
                <div class="m-invoice__container m-invoice__container--centered">
                    <div class="row invoice-header" style="padding-top: 0px;padding-bottom:15px;">
                        ...
                        <span class="m-invoice__desc">
                            <p><span style="font-weight: 600">Bank Reconcile </span></p>
        ...
        methods: {
            ...
            report: function () {
                ...
                if (account_id) {
                    ...
                    _this.$loading(true);
                    axios.get(base_url + "bank-reconcilation-report/?account_id=" + account_id + "&coa_title=" + coa_title + "&from_date=" + from_date + "&end_date=" + end_date)
                        .then((response) => {
                            _this.$loading(false);
            ...
            /* report: function () {
                 var _this = this;
                 axios.post(base_url + 'bank-reconcilation-report/report', this.form)
                     .then((response) => {
                         _this.resultData = response.data;
                     }).catch(error => {
                     if (error.response.status == 422) {
            ...
            doExportPdf() {
                ...
                if (account_id) {
                    ...
                    window.open(base_url + "bank-reconcilation-report/?export=pdf&account_id=" + account_id + "&coa_title=" + coa_title + "&from_date=" + from_date + "&end_date=" + end_date, "_blank");
                } else {
            ...
            doExportExcel() {
                ...
                if (account_id) {
                    ...
                    window.open(base_url + "bank-reconcilation-report/?export=excel&account_id=" + account_id + "&coa_title=" + coa_title + "&from_date=" + from_date + "&end_date=" + end_date, "_blank");
                } else {
