    ...
    <div>
        ...
        <div class="m-portlet__body" v-if="cash_book_list">
            ...
            <div class="table-responsive">
                ...
                <div class="row">
                    <div class="col-md-5"><h3>COA: {{form.coa_title}}</h3></div>
                    <div class="col-md-2"></div>
                    <div class="col-md-5"><h3>From: {{form.from_date}} To {{form.end_date}}</h3></div>
                </div>
                <br>
            ...
            <table class="table table-bordered table-hover" id="m_table_1">
                ...
                <tr v-for="(value,index) in resultData">
                    ...
                    <td> <span v-html="value.chart_of_accounts_title"></span> </td>
                    <td> <span v-html="value.particular"></span> </td>
                    <td> <span v-html="value.party"></span> </td>
                    <td> <span v-html="value.debit"></span> </td>
                    <td> <span v-html="value.credit"></span> </td>
