                ...
                <div class="m-invoice__container m-invoice__container--centered">
                    <div class="row invoice-header"  style="padding-top: 0px;padding-bottom:15px;">
                        ...
                        <span class="m-invoice__desc">
                            <p><span style="font-weight: 600">Income Statement Summary</span></p>
    ...
    export default {
        ...
        methods: {
            ...
            sales:function(){
                ...
                axios.post(base_url+'income-statement-report', this.form)
                    .then( (response) => {
            ...
            doExportPdf() {
                ...
                window.open(base_url + 'income-statement-report?export=pdf&account_id='+ _this.form.account_id +'&from_date='+ _this.form.from_date +'&end_date='+ _this.form.end_date +'', "_blank");
            },

            doExportExcel() {
                var _this = this;

                window.open(base_url + 'income-statement-report?export=excel&account_id='+ _this.form.account_id +'&from_date='+ _this.form.from_date +'&end_date='+ _this.form.end_date +'', "_blank");
            },
        },
