                ...
                <div class="row invoice-header"  style="padding-top: 0px;padding-bottom:15px;">
                    ...
                    <div class="col-md-4 text-center">
                        <span class="m-invoice__desc">
                            <p><span style="font-weight: 600">Sub Code 2 wise Trial Balance</span></p>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            trial_balance(){
                var _this = this;
                axios.post(base_url + 'trial-balance-report-sub2/trial-balance-index-sub2', this.form)
                    .then((response) => {
            ...
            search:function(){
                ...
                axios.post(base_url + 'trial-balance-report-sub2/trial-balance-report-sub2', this.form)
                    .then((response) => {
                        _this.resultData = response.data;
                        setTimeout(function () {
                            jQuery(document).ready(function() {
