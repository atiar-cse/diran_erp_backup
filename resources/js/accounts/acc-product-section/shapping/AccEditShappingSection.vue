            ...
            <div class="m-portlet__body">
                                            ...
                                            <div class="m-invoice__container m-invoice__container--centered">
                                                <div class="row invoice-header" style="padding-top: 24px">
                                                    <div class="col-md-9">
                                                        <div class="db-data">
                                                            ...
                                                            <p><span style="font-weight: 600">Shaping No :</span>
                                                                <span>{{ form.shapping_no }}</span></p>
                                                            <p><span style="font-weight: 600">Shapping Date :</span>
                                                                <span>{{ form.shapping_date }}</span></p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="m-invoice__items">
                                                    <div class="m-invoice__item ">
                                                        <span class="m-invoice__subtitle">Shaping No</span>
                                                        <span class="m-invoice__text">{{ form.shapping_no }}</span>
                                                    </div>
                                                    <div class="m-invoice__item text-center">
                                                        <span class="m-invoice__subtitle">Shapping Date</span>
                                                        <span class="m-invoice__text">{{ form.shapping_date }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr v-for="(details, index) in form.details">
                                                        ...
                                                        <td class="text-center">{{ details.shapping_product_weight }}
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">{{ form.total_trans_to_dryer_weight }}
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="text-right m--font-danger" colspan="7">Process Loss
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="text-right m--font-danger" colspan="8">Total Waste
                                                        </td>
                                                        <td class="m--font-danger">{{ form.weight_after_process_loss
                                                            }}
                                                        </td>
                                                        <td></td>
                                                        <td></td>
                ...
                <div class="form-group m-form__group row">
                    <div class="m-section__content col-lg-12">
                        <!-- Start Account -->
                        <section v-if="permissions.indexOf('acc-shapping-voucher.approve') != -1">
                            <hr>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        ...
                        <div class="col-lg-6 m--align-right">
                            <button type="submit" v-if="permissions.indexOf('acc-shapping-voucher.approve') != -1"
...
<script>
    ...
    export default {
        ...
        props: ['permissions', 'account_lists', 'editId'],
        ...
        methods: {
            ...
            edit(id) {
                var _this = this;
                _this.$loading(true);
                axios.get(base_url + 'acc-shapping-voucher/' + id + '/edit')
                    .then((response) => {
                        _this.$loading(false);
            ...
            update(id, app) {
                ...
                _this.$loading(true);
                axios.put(base_url + 'acc-shapping-voucher/' + id, _this.form)
                    .then((response) => {
                        _this.$loading(false);
