            ...
            <div class="m-portlet__body">
                                        ...
                                        <div class="m-invoice__head">
                                            <div class="m-invoice__container m-invoice__container--centered">
                                                <div class="row invoice-header"  style="padding-top: 24px">
                                                    <div class="col-md-9">
                                                        <div class="db-data">
                                                            <h1 class="print-head-title">Kiln Voucher</h1>
                                                            <p><span style="font-weight: 600">Kiln No :</span> <span>{{ form.kiln_no }}</span></p>
                                                            <p><span style="font-weight: 600">Kiln Date :</span> <span>{{ form.kiln_date }}</span></p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="text-right">Trans to HV Testing Qty</th>
                                                    ...
                                                    <tr v-for="(details, index) in form.details">
                                                        ...
                                                        <td class="text-center">{{ details.kiln_weight }}</td>
                                                        <td class="text-right">{{ details.current_qty }}</td>
                                                        <td class="text-right">{{ details.receive_qty }}</td>
                                                        <td class="text-right">{{ details.trans_to_hv_qty }}</td>
                                                        <td class="text-right">{{ details.trans_to_hv_weight }}</td>
                                                        ...
                                                        <td class="text-right">{{ details.reject_weight }}</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right m--font-danger">{{ form.total_trans_to_hv_qty }}</td>
                                                        <td class="m--font-danger">{{ form.total_trans_weight }}</td>
                                                        <td></td>
                                                        <td class="m--font-danger">{{ form.total_amount }}</td>
                                                        <td class="m--font-danger">{{ form.total_reject_qty }}</td>
                                                        <td class="m--font-danger">{{ form.total_reject_weight }}</td> 
                ...
                <div class="form-group m-form__group row">
                    <div class="m-section__content col-lg-12">
                        <!-- Start Account -->
                        <section v-if="permissions.indexOf('acc-kiln-voucher.approve') != -1" >
                            <hr>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            <button type="submit" v-if="permissions.indexOf('acc-kiln-voucher.approve') != -1" class="btn btn-sm btn-primary" @click.prevent="update(form.id,1)" ><i class="la la-check"></i> <span>Approve</span></button>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'acc-kiln-voucher/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id,app){
                ...
                axios.put(base_url+'acc-kiln-voucher/'+id, this.form).then( (response) => {
