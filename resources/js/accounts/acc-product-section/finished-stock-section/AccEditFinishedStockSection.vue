            ...
            <div class="m-portlet__body">
                                        ...
                                        <div class="m-invoice__head">
                                            <div class="m-invoice__container m-invoice__container--centered">
                                                <div class="row invoice-header"  style="padding-top: 24px">
                                                    <div class="col-md-9">
                                                        <div class="db-data">
                                                            <h1 class="print-head-title">Finished Stock Voucher</h1>
                                                            <p><span style="font-weight: 600">No :</span> <span>{{ form.finished_stock_no }}</span></p>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr v-for="(details, index) in form.details">
                                                        ...
                                                        <td class="text-right">{{ details.trans_to_store_qty }}</td>
                ...
                <div class="form-group m-form__group row">
                    <div class="m-section__content col-lg-12">
                        <!-- Start Account -->
                        <section v-if="permissions.indexOf('acc-finish-stock-voucher.approve') != -1" >
                            <hr>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            <button type="submit" v-if="permissions.indexOf('acc-finish-stock-voucher.approve') != -1" class="btn btn-sm btn-primary" @click.prevent="update(form.id,1)" ><i class="la la-check"></i> <span>Approve</span></button>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'acc-finish-stock-voucher/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id,app){
                ...
                axios.put(base_url+'acc-finish-stock-voucher/'+id, this.form).then( (response) => {
