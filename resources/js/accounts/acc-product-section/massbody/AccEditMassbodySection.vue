                ...
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group row">
                        <div class="m-section__content col-lg-12">
                            <!-- Start Account -->
                            <section v-if="permissions.indexOf('acc-mass-body-voucher.approve') != -1" >
                                <hr>
                    ...
                    <div class="m-form__actions m-form__actions--solid">
                        <div class="row">
                            <div class="col-lg-12 m--align-right">
                                <button type="submit" v-if="permissions.indexOf('acc-mass-body-voucher.approve') != -1" class="btn btn-sm btn-primary" @click.prevent="update(form.id,1)" ><i class="la la-check"></i> <span>Approve</span></button>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'acc-mass-body-voucher/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id,app){
                ...
                axios.put(base_url+'acc-mass-body-voucher/'+id, _this.form)
                    .then( (response) => {
