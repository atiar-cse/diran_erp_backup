            ...
            <div class="m-portlet__body">
                                                ...
                                                <div class="row invoice-header" style="padding-top: 24px">
                                                    <div class="col-md-9">
                                                        <div class="db-data">
                                                            ...
                                                            <p><span style="font-weight: 600">Dryer No :</span> <span>{{ form.dryer_no }}</span>
                                                            </p>
                                                            <p><span style="font-weight: 600">Dryer Date :</span> <span>{{ form.dryer_date }}</span>
                                                            </p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="m--font-danger">{{ form.total_trans_to_glaze_qty }}
                                                        </td>
                                                        <td class="m--font-danger">{{ form.total_trans_to_glaze_weight
                                                            }}
                                                        </td>
                ...
                <div class="form-group m-form__group row">
                    <div class="m-section__content col-lg-12">
                        <!-- Start Account -->
                        <section v-if="permissions.indexOf('acc-dryer-voucher.approve') != -1">
                            <hr>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            <button type="submit" v-if="permissions.indexOf('acc-dryer-voucher.approve') != -1"
    ...
    export default {
        ...
        methods: {
            ...
            edit(id) {
                var _this = this;
                _this.$loading(true);
                axios.get(base_url + 'acc-dryer-voucher/' + id + '/edit')
                    .then((response) => {
                        _this.$loading(false);
            ...
            update(id, app) {
                ...
                _this.$loading(true);
                axios.put(base_url + 'acc-dryer-voucher/' + id, _this.form)
                    .then((response) => {
                        _this.$loading(false);
