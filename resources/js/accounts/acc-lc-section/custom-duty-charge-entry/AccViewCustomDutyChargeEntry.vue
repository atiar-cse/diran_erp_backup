                                    ...
                                    <div class="m-invoice__head">
                                        <div class="m-invoice__container m-invoice__container--centered">
                                            <div class="row invoice-header" style="padding-top: 24px">
                                                <div class="col-md-9">
                                                    <div class="db-data">
                                                        <h1 class="print-head-title">LC Custom Duty Charge</h1>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6" style="float:left;width:50%">
                                                    <p>
                                                        ...
                                                        <span>
                                                        {{form.custom_duty_date}}
                                                    </span>
                                                    </p>
                                                </div>
                                                <div class="col-md-6" style="float:left;width:50%">
                                                    <p>
                                                        <span style="font-weight: 600">Custom Duty Cost Name :</span>
                                                        <span>
                                                        {{form.get_custom_duty ? form.get_custom_duty.duty_cost_name : ''}}
                                                    </span>
                                                    </p>
                                                </div>
                                                <div v-if="form.get_cnf_agent" class="col-md-6"
                                                     style="float:left;width:50%">
                                                    <p>
                                                        <span style="font-weight: 600">C&F Agent / Party :</span>
                                                        <span>
                                                        {{form.get_cnf_agent}}
                                                    </span>
                                                    </p>
    ...
    export default {
        ...
        methods: {
            ...
            show(id) {
                var _this = this;
                _this.$loading(true);
                axios.get(base_url + 'acc-custom-duty-charge-entry/' + id)
                    .then((response) => {
                        _this.$loading(false);
