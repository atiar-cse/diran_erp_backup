<template>
    <div>
        ...
        <AddAccountSubCode
                :accounts_main_code_list="accounts_main_code_list"
        ></AddAccountSubCode>
    </div>
</template>
...
<script>
    ...
    import AddAccountSubCode from './AddAccountSubCode.vue';
    ...
    export default {
        ...
        data: function(){
            return {
                ...
                //VdtnetTable Options
                tableId: 'account-sub-code',
                options: {
                    ajax: {
                      url: base_url+"account-sub-code",
                      dataSrc: (json) => {
                        return json.data
                      }
                    },
                ...
                fields: {
                    id: { label: 'ID' },
                    'accounts_main_codes.main_code_title': { label: 'Account Main Code', template: '{{ row.main_code_title }} ({{ row.main_code }})', sortable: true, searchable: true },
                    sub_code_title: { label: 'Sub Code Title',sortable: true, searchable: true },
                    sub_code: { label: 'Sub Code', sortable: true, searchable: true/*, defaultOrder: 'asc' */ },
                    ...
                    actions: {
                      ...
                      render: (data) => {
                        var htmlButtons = '';
                        if (this.permissions.indexOf('account-sub-code.edit') != -1) {
            ...
            /*deleteData(id){
                ...
                swal({
                    ...
                    function(){
                        ...
                        axios.delete(base_url+'account-sub-code/'+id).then((response) => {
                            _this.index(1);
