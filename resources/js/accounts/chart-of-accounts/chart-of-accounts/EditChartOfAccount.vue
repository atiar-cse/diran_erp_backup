        ...
        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="update(form.id)" id="editComponent" class="m-form m-form--fit m-form--label-align-right" >
            <div class="m-portlet__body">
                <div class="form-group m-form__group row" :class="{'has-danger': (errors.hasOwnProperty('sub_code2_id'))}">
                    ...
                    <div class="col-lg-6">
                        <select class="form-control m-select2 select2" data-selectField="sub_code2_id" id="sub_code2_id" v-model="form.sub_code2_id" disabled >
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        <input type="text" id="opening_balance" v-model="form.opening_balance" class="form-control form-control-sm m-input" placeholder="Enter Opening Balance" readonly>
...
<script>
    ...
    export default {
        props:['permissions','sub_code2_list','editId'],
        ...
        methods:{
            edit(id) {
                var _this = this;
                axios.get(base_url+'chart-of-accounts/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id){
                axios.put(base_url+'chart-of-accounts/'+id, this.form).then( (response) => {
