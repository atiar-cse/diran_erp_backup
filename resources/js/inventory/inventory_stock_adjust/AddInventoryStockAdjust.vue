                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button v-if="permissions.indexOf('stock-adjust.approve') !=-1" type="submit" class="btn btn-sm btn-success"  @click.prevent="store(1)"><i class="la la-check"></i> <span>Approve</span></button>
                          </div>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        methods:{
            ...
            transactionNoGenerate(){
                var _this = this;
                axios.get(base_url+'stock-adjust?token_stock_adjust_gen=1')
                    .then( (response) => {
                        _this.form.inventory_stock_adjusts_no = response.data;
                    });
            },
