<template>
    <div>
        ...
        <AddInventoryStockAdjust
                ...
                :enum_val="enum_val"
                :warehouse_lists="warehouse_lists"></AddInventoryStockAdjust>
        <EditInventoryStockAdjust
                ...
                :edit-id="edit_id"
                :enum_val="enum_val"
                :warehouse_lists="warehouse_lists"></EditInventoryStockAdjust>
...
<script>
    ...
    export default {
        ...
        props:['permissions','product_lists','enum_val','warehouse_lists'],
        ...
        data: function(){
            return {
                ...
                fields: {
                    id: { label: 'ID' },
                    inventory_stock_adjusts_no: { label: 'Stock Adjust NO', sortable: true, searchable: true, defaultOrder: 'DESC'  },
                    ...
                    inventory_stock_adjusts_narration: { label: 'Narration' },
                    'inventory_stock_adjusts.created_by': { label: 'User', template: '<span v-if="row.ad_name">Added By : {{ row.ad_name }}</span><br><span v-if="row.ed_name">Edited By  : {{ row.ed_name }}</span><br><span v-if="row.approve_status==1 && row.ap_name">Approved By  : {{ row.ap_name }} </span><br>', sortable: false, searchable: false },
                    ...
                    actions: {
                        ...
                        render: (data,type,row,meta) => {
                            ...
                            if (this.permissions.indexOf('stock-adjust.edit') != -1 && row.approve_status !=1) {
                            ...
                            if (this.permissions.indexOf('stock-adjust.destroy') != -1 && row.approve_status !=1) {
                            ...
                            if (this.permissions.indexOf('stock-adjust.show') != -1 && row.approve_status ==1) {
        ...
        methods: {
            ...
            deleteData(id,tr){
                ...
                swal({
                    ...
                    function(){
                        swal("Deleted!", "Your Stock Adjust has been deleted.", "success");
