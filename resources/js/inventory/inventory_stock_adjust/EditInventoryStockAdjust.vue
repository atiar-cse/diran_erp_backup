                        ...
                        <div class ="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(details, index) in form.details">
                                    ...
                                    <td>
                                        <input type="text" v-model="details.inventory_stock_adjust_details_qty" class="form-control form-control-sm m-input" placeholder="">
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button v-if="permissions.indexOf('stock-adjust.approve') !=-1" type="submit" class="btn btn-sm btn-success" @click.prevent="update(form.id,1)" ><i class="la la-check"></i> <span>Approve</span></button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        props:['permissions','editId','product_lists','enum_val','warehouse_lists'],
        data:function(){
            return{
                product_list:false,
                add_form:false,
        ...
        methods:{
            ...
            update(id,app){
                ...
                axios.put(base_url+'stock-adjust/'+id+'/update',
                    _this.form).then( (response) => {
