                        ...
                        <div class="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(details, index) in form.details">
                                    ...
                                    <td>
                                        <input type="text"
                                               v-model="details.inventory_product_damage_details_description"
    ...
    export default {
        ...
        methods: {
            ...
            transactionNoGenerate() {
                var _this = this;
                _this.$loading(true);
                axios.get(base_url + 'product-damage?token_product_damage_gen=1')
                    .then((response) => {
                        _this.$loading(false);
                        _this.form.inventory_product_damages_no = response.data;
                    });
            },
            ...
            store: function () {
                var _this = this;
                _this.$loading(true);
                axios.post(base_url + 'product-damage/store', _this.form)
                    .then((response) => {
                        _this.$loading(false);
