                        ...
                        <div class="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(details, index) in form.details">
                                    ...
                                    <td>
                                        <input type="text" v-model="details.inventory_product_damage_details_qty"
                                               @keyup="totalQtyAndPrice()" class="form-control form-control-sm m-input"
                                               placeholder="">
                                        <div class="requiredField"
                                    ...
                                    <td>
                                        <input type="text" v-model="details.inventory_product_damage_details_unit_price"
                                               @keyup="totalQtyAndPrice()" class="form-control form-control-sm m-input">
                                        <div class="requiredField"
                                             v-if="errors['details.'+index+'.inventory_product_damage_details_unit_price']">
                                            {{
                                            errors['details.'+index+'.inventory_product_damage_details_unit_price'][0]
                                            }}
                                        </div>
                                    </td>
                                    <td class="width-160">
                                        <input type="text"
                                               v-model="details.inventory_product_damage_details_total_price"
                                               class="form-control form-control-sm m-input width-160">
                                        <div class="requiredField"
                                             v-if="errors['details.'+index+'.inventory_product_damage_details_total_price']">
                                            {{
                                            errors['details.'+index+'.inventory_product_damage_details_total_price'][0]
                                            }}
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <input type="text" v-model="form.inventory_product_damages_total_qty"
                                               class="form-control form-control-sm m-input">
                                    </td>
                                    <td class="text-right">Total Amount</td>
                                    <td class="">
                                        <input type="text" v-model="form.inventory_product_damages_total_price"
                                               class="form-control form-control-sm m-input">
                                    </td>
                                    <td></td>
                                </tr>
...
<script>
    ...
    export default {
        ...
        props: ['editId', 'product_lists', 'warehouse_lists'],
