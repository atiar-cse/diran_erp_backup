<template>
    <div>
        ...
        <AddInventoryProductDamage  v-else-if="add_form" :product_lists="product_lists" :inventory_product_damage_no="inventory_product_damage_no"  :warehouse_lists="warehouse_lists"></AddInventoryProductDamage>
        <EditInventoryProductDamage  v-else-if="edit_form" :product_lists="product_lists" :edit-id="edit_id"  :warehouse_lists="warehouse_lists" ></EditInventoryProductDamage>
...
<script>
    ...
    export default {
        ...
        props:['permissions','inventory_product_damage_no','product_lists','warehouse_lists'],
        ...
        data: function(){
            return {
                ...
                fields: {
                    ...
                    inventory_product_damages_narration: { label: 'Narration',sortable: false, searchable: false },
                    inventory_product_damages_total_qty: { label: 'Total Qty', sortable: false, searchable: false  },
                    inventory_product_damages_total_price: { label: 'Total Price', sortable: false, searchable: false  },
                    ...
                    actions: {
                        ...
                        render: (data) => {
                            ...
                            if (this.permissions.indexOf('product-damage.edit') != -1 ) {
                            ...
                            if (this.permissions.indexOf('product-damage.destroy') != -1 ) {
