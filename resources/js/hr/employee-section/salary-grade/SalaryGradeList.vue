            ...
            <table class="table table-bordered table-hover" id="m_table_1">
                ...
                <tr v-for="(value,index) in resultData.data">
                    ...
                    <td scope="row" class="width-100 text-center">
                        <a v-if="permissions.indexOf('salary-grade.edit') != -1" @click="openUpdateModal(value.id)"
                        ...
                        <a v-if="permissions.indexOf('salary-grade.destroy') != -1" @click="deleteData(value.id)"
...
<script>
    ...
    import AddSalaryGrade from './AddSalaryGrade.vue';
    ...
    export default {
        ...
        methods: {
            index(pageNo, perPage) {
                ...
                _this.$loading(true);
                axios.get(base_url + "salary-grade/?page=" + pageNo + "&perPage=" + perPage)
                    .then((response) => {
                        _this.$loading(false);
            ...
            deleteData(id) {
                ...
                swal({
                    ...
                    function () {
                        ...
                        _this.$loading(true);
                        axios.delete(base_url + 'salary-grade/' + id)
                            .then((response) => {
                                _this.$loading(false);
                                _this.index(1);
