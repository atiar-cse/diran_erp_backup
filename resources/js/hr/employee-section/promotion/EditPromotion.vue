                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4">
                        <select class="form-control select2" id="promoted_pay_grade"  v-model="form.promoted_pay_grade" data-selectField="promoted_pay_grade">
                            ...
                            <option v-for="(value,index) in paygrade_lists" :value="value.id"> {{value.pay_grade_name}}</option>
                        </select>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'promotion/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id){
                axios.put(base_url+'promotion/'+id, this.form).then( (response) => {
