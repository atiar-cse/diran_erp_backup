<template>
    <div>
        ...
        <AddPromotion  v-else-if="add_form"
        ...
        ></AddPromotion>
        <EditPromotion  v-else-if="edit_form"
                        :employee_lists="employee_lists"
                        :paygrade_lists="paygrade_lists"
                        :department_lists="department_lists"
                        :designation_lists="designation_lists"
    ...
    export default {
        ...
        methods: {
            index(pageNo,perPage){
                ...
                axios.get(base_url+"promotion/?page="+pageNo+"&perPage="+perPage).then((response) => {
            ...
            deleteData(id){
                ...
                swal({
                    ...
                    function(){
                        ...
                        axios.delete(base_url+'promotion/'+id).then((response) => {
                            _this.index(1);
