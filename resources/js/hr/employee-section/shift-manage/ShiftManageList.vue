<template>
    <div>
        <div class="m-portlet__body">
            ...
            <table class="table table-bordered table-hover" id="m_table_1">
                ...
                <tr v-for="(value,index) in resultData.data">
                    ...
                    <td>{{value.get_shift_schedule ? value.get_shift_schedule.title:''}}</td>
                    <td>
                    ...
                    <td class="width-100 text-center" scope="row">
                        <a @click="openUpdateModal(value.id)"
                           ...
                           v-if="permissions.indexOf('shift-manage.edit') != -1"><i
                        ...
                        <a @click="deleteData(value.id)"
                           ...
                           v-if="permissions.indexOf('shift-manage.destroy') != -1"><i
        ...
        <AddShiftManage
            :shift_schedule_list="shift_schedule_list"
        ></AddShiftManage>
    </div>
</template>
...
<script>
    ...
    import AddShiftManage from './AddShiftManage.vue';
    ...
    export default {
        ...
        methods: {
            index(pageNo, perPage) {
                ...
                _this.$loading(true);
                axios.get(base_url + "shift-manage/?page=" + pageNo + "&perPage=" + perPage)
                    .then((response) => {
                        _this.$loading(false);
            ...
            deleteData(id) {
                ...
                swal({
                    ...
                    function () {
                        ...
                        _this.$loading(true);
                        axios.delete(base_url + 'shift-manage/' + id)
                            .then((response) => {
                                _this.$loading(false);
                                _this.index(1);
