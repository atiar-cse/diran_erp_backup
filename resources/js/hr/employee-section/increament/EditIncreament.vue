        ...
        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="update(form.id)" id="editComponent" class="m-form m-form--fit m-form--label-align-right"  >
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4">
                        <input type="text" id="current_salary_display" v-model="form.current_salary" class="form-control form-control-sm m-input" placeholder="Salary">
                        <div class="requiredField" v-if="(errors.hasOwnProperty('current_salary'))">{{ (errors.hasOwnProperty('current_salary')) ? errors.current_salary[0] :'' }}</div>
                    </div>
                    <label for="new_salary" class="col-lg-2 col-form-label">New Salary <span class="requiredField">*</span></label>
                    <div class="col-lg-4">
                        <input type="text" id="new_salary" v-model="form.new_salary" class="form-control form-control-sm m-input" placeholder="Enter new salary">
...
<script>
    ...
    export default {
        ...
        props:['permissions','employee_lists','paygrade_lists','department_lists','designation_lists','editId'],
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'increament/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id){
                axios.put(base_url+'increament/'+id, this.form).then( (response) => {
