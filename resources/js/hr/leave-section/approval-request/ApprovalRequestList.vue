        ...
        <div class="m-portlet__body">
            ...
            <table class="table table-bordered table-hover" id="m_table_1">
                ...
                <tr>
                    ...
                    <th>Contact Person Job Title</th>
                ...
                <tr v-for="(value,index) in resultData.data">
                    ...
                    <td>{{value.sales_customer_contact_person_name}}</td>
                    <td>{{value.sales_customer_contact_person_job_title}}</td>
                    <td>{{value.sales_customer_business_phone}}</td>
                    <td>{{value.sales_customer_mobile}}<br/> {{value.sales_customer_email}}</td>
                    <td>{{value.sales_customer_office_address}}</td>
                    <td>
    ...
    export default {
        ...
        methods: {
            index(pageNo,perPage){
                ...
                axios.get(base_url+"bank/?page="+pageNo+"&perPage="+perPage).then((response) => {
