        ...
        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="store" id="addComponent" class="m-form m-form--fit m-form--label-align-right" >
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <label for="leave_type_id" class="col-lg-2 col-form-label">Leave Category <span class="requiredField">*</span></label>
                    <div class="col-lg-4">
                        <select class="form-control select2" id="leave_type_id"  v-model="form.leave_type_id"  data-selectField="leave_type_id"  @change ="currentBalance()">
                    ...
                    <div class="col-lg-8">
                        <div class="m-checkbox-list">
                            <label class="m-checkbox">
                                Half leave ? <input type="checkbox" id="half_leave"  v-model="form.check_status" @click="half_leave()">
                                <span></span>
                            </label>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            store:function(){
                var _this = this;
                axios.post(base_url+'apply-for-leave', this.form).then( (response) => {
