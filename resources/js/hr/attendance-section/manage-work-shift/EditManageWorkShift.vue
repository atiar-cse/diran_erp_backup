            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    <label class="col-lg-3 col-form-label" for="start_time">Start Time <span
                        class="requiredField">*</span></label>
                    <div class="col-lg-6">
                        <!--<input type="text" id="start_time" v-model="form.start_time" class="form-control form-control-sm m-input" placeholder="Enter start time">-->
    ...
    export default {
        ...
        methods: {
            edit(id) {
                var _this = this;
                _this.$loading(true);
                axios.get(base_url + 'manage-work-shift/' + id + '/edit')
                    .then((response) => {
                        _this.$loading(false);
            ...
            update(id) {
                var _this = this;
                _this.$loading(true);
                axios.put(base_url + 'manage-work-shift/' + id, _this.form)
                    .then((response) => {
                        _this.$loading(false);
