<template>
    <div>
        ...
        <div class="m-portlet__body" v-if="dryer_report_list">
            ...
            <div class="m-invoice__head print_only">
                <div class="m-invoice__container m-invoice__container--centered">
                    <div class="row invoice-header"  style="padding-top: 0px;padding-bottom:15px;">
                        <div class="col-md-4">
                            <div class="db-data">
                                <p><span style="font-weight: 600">Section :</span> <span>Dryer</span></p>
            ...
            <table class="table table-bordered table-hover" id="m_table_1">
                ...
                <tbody v-if="resultData !=''">
                    <tr v-for="(value,index) in resultData.prod_dryer_details">
                        <td>{{++index}}</td>
                        <td>{{value.product.product_name}}</td>
                        <td>{{value.opening_qty}}</td>
                        <td>{{value.prod_of_month}}</td>
                        <td>{{value.total}}</td>
                        <td>{{value.trans_to_glaze_qty}}</td>
                        <td></td>
    ...
    export default {
        ...
        methods: {
            ...
            search: function () {
                ...
                axios.get(base_url+"dryer-report/?from_date="+from_date+"&to_date="+to_date).then((response) => {
            ...
            formatData(){
                ...
                var prod_dryer_details = _this.resultData.prod_dryer_details;
                prod_dryer_details.forEach(function(item) {
                    ...
                    item.total_issue = parseFloat(item.trans_to_glaze_qty) /*+ parseFloat(item.glaze_westage_qty)*/;
