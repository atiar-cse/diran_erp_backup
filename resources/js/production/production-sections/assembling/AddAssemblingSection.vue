    ...
    <div>
        ...
        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="store" id="addComponent"
            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    <label class="col-lg-2 col-form-label" for="overhead_kg_price">Previous month overhead price
                        (Kg)</label>
                    <div class="col-lg-4">
        ...
        mounted() {
            ...
            $('#addComponent').on('change', '.select2', function (e) {
                ...
                if (selectField == 'assembling_types') {
                    ...
                    var finish_product_unit_price = $('option:selected', $(e.target)).attr('finish-product-buying-price');
