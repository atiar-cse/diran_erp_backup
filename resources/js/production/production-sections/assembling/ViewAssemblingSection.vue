                        ...
                        <div class="m-portlet__body m-portlet__body--no-padding">
                            <div class="m-invoice-2">
                                <div class="m-invoice__wrapper">
                                    <div class="m-invoice__head">
                                        <div class="m-invoice__container m-invoice__container--centered">
                                            <div class="row invoice-header"  style="padding-top: 24px">
                                                <div class="col-md-9">
                                                    <div class="db-data">
                                                        <h1 class="print-head-title">Assembling</h1>
                                                        <p><span style="font-weight: 600">Assembling No :</span> <span>{{ form.assembling_no }}</span></p>
                                                        <p><span style="font-weight: 600">Assembling Date :</span> <span>{{ form.assembling_date }}</span></p>
                                                        <p><span style="font-weight: 600">Store Warehouse :</span> <span>{{ form.warehouse_id }}</span></p>
                                                        <p><span style="font-weight: 600">Assembling Types :</span> <span>{{ form.assembling_types }}</span></p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="m-invoice__items">
                                                ...
                                                <div class="m-invoice__item text-center">
                                                    <span class="m-invoice__subtitle">Trans to Inventory Store Qty</span>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-right">Rec.F Testing Qty</th>
                                                    <th>Adj. Qty</th>
                                                    <th class="text-right">Unit Price</th>
                                                    <th class="text-right"> Trans to Packing Qty</th>
                                                ...
                                                <tr v-for="(details, index) in form.details">
                                                    ...
                                                    <td class="text-right">{{ details.trans_to_packing_qty }}</td>
                                    ...
                                    <!-- Inventory Materials -->
                                    <div class="m-invoice__body m-invoice__body--centered">
                                         <strong>Assembling Materials (Inventory)</strong>
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <thead>
                                                <tr>
    ...
    export default {
        ...
        methods:{
            ...
            show(id) {
                ...
                axios.get(base_url+'assembling-section/'+id)
                    .then( (response) => {
            ...
            doExportPdf() {
                var _this = this;
                var id = _this.editId;
                window.open(base_url + 'assembling-section?export=pdf&id='+id +'', "_blank");
