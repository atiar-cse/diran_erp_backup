...
<script>
    ...
    import AddAssemblingSection from './AddAssemblingSection.vue';
    import EditAssemblingSection from './EditAssemblingSection.vue';
    import ViewAssemblingSection from './ViewAssemblingSection.vue';
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                //VdtnetTable Options
                tableId: 'assembling-section',
                options: {
                    ajax: {
                        url: base_url + "assembling-section",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    ...
                    'production_products.product_name': {
                        label: 'Finishing Product',
                        template: '{{ row.product_name }}',
                        sortable: true,
                        searchable: true
                    },
                    trans_to_packing_qty: {label: 'Trans to Packing Qty'},
                    ...
                    actions: {
                        ...
                        render: (data, type, row, meta) => {
                            var htmlButtons = '';
                            if (this.permissions.indexOf('assembling-section.edit') != -1 && row.approve_status != 1) {
                            ...
                            if (this.permissions.indexOf('assembling-section.destroy') != -1 && row.approve_status != 1) {
                            ...
                            if (this.permissions.indexOf('assembling-section.show') != -1) {
            ...
            deleteData(id, tr) {
                ...
                swal({
                    ...
                    function () {
                        ...
                        _this.$loading(true);
                        axios.delete(base_url + 'assembling-section/' + id + '/delete')
                            .then((response) => {
                                _this.$loading(false);
