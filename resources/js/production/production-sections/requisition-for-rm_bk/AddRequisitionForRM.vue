        ...
        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="store" id="addComponent" class="m-form m-form--fit m-form--label-align-right" >
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    <label for="requisition_no" class="col-lg-2 col-form-label">Requisition No <span class="requiredField">*</span></label>
                    <div class="col-lg-4">
                        <input type="text" id="requisition_no" v-model="form.rm_requisition_no" class="form-control form-control-sm m-input" placeholder="Enter requisition no" readonly autocomplete="off">
                    ...
                    <label for="date" class="col-lg-2 col-form-label">Requisition Date <span class="requiredField">*</span></label>
                    <div class="col-lg-4">
                        <div class="input-group date">
                            <input type="text" id="date" class="form-control form-control-sm m-input datepicker" v-model="form.requisition_date" data-dateField="requisition_date" placeholder="Select date from picker" autocomplete="off"/>
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4">
                            <select class="form-control m-bootstrap-select m_selectpicker" id="requisition_types" v-model="form.requisition_types" @change="getRmSetupData()">
                                <option value="Normal Requisition" selected>Normal Requisition</option>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            <button type="submit" v-if="permissions.indexOf('requisition-for-raw-material.approve') != -1" @click.prevent="store(1)" class="btn btn-sm btn-primary"><i class="la la-check"></i> <span>Approve</span></button>
                            <button type="submit" @click.prevent="store(0)" class="btn btn-sm btn-success" ><i class="la la-check"></i> <span>Save and Go List</span></button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        props:['permissions','product_lists','warehouse_lists','account_lists'],
