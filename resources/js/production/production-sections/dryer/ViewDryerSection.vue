                                    ...
                                    <div class="m-invoice__head">
                                        <div class="m-invoice__container m-invoice__container--centered">
                                            <div class="row invoice-header"  style="padding-top: 24px">
                                                <div class="col-md-9">
                                                    <div class="db-data">
                                                        <h1 class="print-head-title">Dryer</h1>
                                            ...
                                            <div class="m-invoice__items">
                                                <div class="m-invoice__item ">
                                                    <span class="m-invoice__subtitle">Dryer Date</span>
                                                    <span class="m-invoice__text">{{ form.dryer_no }}</span>
                                                </div>
                                                <div class="m-invoice__item text-center">
                                                    <span class="m-invoice__subtitle">Dryer No</span>
                                                    <span class="m-invoice__text">{{ form.dryer_date }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-right">Rec.F Shapping Qty</th>
                                                ...
                                                <tr v-for="(details, index) in form.details">
                                                    ...
                                                    <td class="text-center">{{ details.dryer_product_weight.toFixed(2) }}</td>
    ...
    export default {
        ...
        methods:{
            ...
            show(id) {
                ...
                axios.get(base_url+'dryer-section/'+id)
                    .then( (response) => {
            ...
            doExportPdf() {
                var _this = this;
                var id = _this.editId;
                window.open(base_url + 'dryer-section?export=pdf&id='+id +'', "_blank");
