...
<script>
    ...
    import AddDryerSection from './AddDryerSection.vue';
    import EditDryerSection from './EditDryerSection.vue';
    import EditCorrectionDryerSection from './EditCorrectionDryerSection.vue';
    import ViewDryerSection from './ViewDryerSection.vue';
    ...
    export default {
        ...
        data: function(){
            return {
                ...
                //VdtnetTable Options
                tableId: 'dryer-section',
                options: {
                    ajax: {
                        url: base_url+"dryer-section",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    id: { label: 'ID' },
                    dryer_no: { label: 'Dryer NO', sortable: true, searchable: true, defaultOrder: 'DESC'  },
                    dryer_date: { label: 'Dryer Date', sortable: true, searchable: true  },
                    ...
                    'production_dryers.created_by': { label: 'User', template: '<span v-if="row.ad_name">Added By : {{ row.ad_name }}</span><br><span v-if="row.ed_name">Edited By  : {{ row.ed_name }}</span><br><span v-if="row.approve_status==1 && row.ap_name">Approved By  : {{ row.ap_name }} </span><br>', sortable: false, searchable: false },
                    ...
                    actions: {
                        ...
                        render: (data,type,row,meta) => {
                            var htmlButtons = '';
                            if (this.permissions.indexOf('dryer-section.edit') != -1 && row.approve_status !=1) {
                            ...
                            if (this.permissions.indexOf('dryer-section.destroy') != -1 && row.approve_status !=1) {
                            ...
                            if (this.permissions.indexOf('dryer-section.show') != -1 ) {
                            ...
                            if ((this.permissions.indexOf('super-admin') != -1 || this.permissions.indexOf('dryer-section.unapprove') != -1) && row.approve_status ==1 ) {
            ...
            deleteData(id,tr){
                ...
                swal({
                    ...
                    function(){
                        ...
                        axios.delete(base_url+'dryer-section/'+id+'/delete').then((response) => {
