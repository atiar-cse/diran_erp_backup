        ...
        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="update(form.id)" id="editComponent"
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    <label for="forming_no" class="col-lg-2 col-form-label">Dryer No <span
                        class="requiredField">*</span></label>
                    <div class="col-lg-4">
                        <input type="text" id="forming_no" v-model="form.dryer_no"
                               class="form-control form-control-sm m-input" placeholder="Enter Dryer No" readonly>
                        <div class="requiredField" v-if="(errors.hasOwnProperty('dryer_no'))">{{
                            (errors.hasOwnProperty('dryer_no')) ? errors.dryer_no[0] :'' }}
                        </div>
                    </div>
                    <label for="m_datepicker_2" class="col-lg-2 col-form-label">Dryer Date <span
                        class="requiredField">*</span></label>
                    <div class="col-lg-4">
                        <div class="input-group date">
                            <input type="text" class="form-control form-control-sm m-input datepicker"
                                   v-model="form.dryer_date" data-dateField="forming_date" disabled
                        ...
                        <div class="requiredField" v-if="(errors.hasOwnProperty('dryer_date'))">{{
                            (errors.hasOwnProperty('dryer_date')) ? errors.dryer_date[0] :'' }}
                        </div>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                                ...
                                <tr v-for="(details, index) in form.details">
                                    ...
                                    <td class="width-210">
                                        <select class="form-control select2 select-product width-210"
                                            ...
                                            > {{value.product_name}} ({{value.product_category_code}})
                                            </option>
                                        </select>
                                    ...
                                    <td>
                                        <input type="number" step="any"
                                               ...
                                               v-model="details.dryer_product_weight" @input="totalWeightCalc()"
                                               placeholder="" readonly>
                                        <div class="requiredField"
                                             v-if="errors['details.'+index+'.dryer_product_weight']">{{
                                            errors['details.'+index+'.dryer_product_weight'][0] }}
                                        </div>
                                    </td>
                                    <td>
                                        <input type="number" step="any"
                                               class="form-control form-control-sm m-input width-80"
                                               v-model="details.current_qty" @input="totalWeightCalc()" readonly>
                                    ...
                                    <td>
                                        <input type="number" step="any"
                                               class="form-control form-control-sm m-input width-80"
                                               v-model="details.receive_qty" placeholder="" @input="totalWeightCalc()"
                                               readonly>
                                    ...
                                    <td>
                                        <input type="number" step="any"
                                               class="form-control form-control-sm m-input width-80"
                                               v-model="details.trans_to_glaze_qty" @input="totalWeightCalc()"
                                               placeholder="" readonly>
                                        <div class="requiredField"
                                             v-if="errors['details.'+index+'.trans_to_glaze_qty']">{{
                                            errors['details.'+index+'.trans_to_glaze_qty'][0] }}
                                        </div>
                                    </td>
                                    <td>
                                        <input type="number" class="form-control form-control-sm m-input width-80"
                                               v-model="details.trans_to_glaze_weight" placeholder="" readonly>
                                        <div class="requiredField"
                                             v-if="errors['details.'+index+'.trans_to_glaze_weight']">{{
                                            errors['details.'+index+'.trans_to_glaze_weight'][0] }}
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <input type="number" step="any"
                                               class="form-control form-control-sm m-input width-80"
                                               v-model="details.glaze_westage_qty" @input="totalWeightCalc()"
                                               placeholder="" readonly>
                                        <div class="requiredField" v-if="errors['details.'+index+'.glaze_westage_qty']">
                                            {{ errors['details.'+index+'.glaze_westage_qty'][0] }}
                                        </div>
                                    </td>
                                    <td>
                                        <input type="number" step="any"
                                               class="form-control form-control-sm m-input width-80"
                                               v-model="details.glaze_westage_weight" placeholder="" readonly>
                                        <div class="requiredField"
                                             v-if="errors['details.'+index+'.glaze_westage_weight']">{{
                                            errors['details.'+index+'.glaze_westage_weight'][0] }}
                                        </div>
                                    </td>
                                    <td class="width-160">
                                        <input type="number" step="any"
                                               class="form-control form-control-sm m-input width-160"
                                               v-model="details.remain_qty" @input="totalWeightCalc()" readonly>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" v-model="form.total_receive_qty"
                                               class="form-control form-control-sm m-input" placeholder="Recive Qty"
                                               readonly>
                                    </td>
                                    <td>
                                        <input type="text" v-model="form.total_trans_to_glaze_qty"
                                               class="form-control form-control-sm m-input"
                                               placeholder="Total Glaze Qty" readonly>
                                    </td>
                                    <td>
                                        <input type="text" v-model="form.total_trans_to_glaze_weight"
                                               class="form-control form-control-sm m-input" placeholder="Total Weight"
                                               readonly>
                                    </td>
                                    <td>
                                        <input type="number" step="any" v-model="form.total_waste_qty"
                                               class="form-control form-control-sm m-input" placeholder="Waste Qty"
                                               readonly>
                                    </td>
                                    <td>
                                        <input type="number" step="any" v-model="form.total_waste_weight"
        ...
        methods: {
          ...
          getOverheadCosting(){
            ...
            edit(id) {
                var _this = this;
                _this.$loading(true);
                axios.get(base_url + 'dryer-section/' + id + '/edit')
                    .then((response) => {
                        _this.$loading(false);
            ...
            update(id, app) {
                ...
                _this.$loading(true);
                axios.put(base_url + 'dryer-section/' + id + '?isSuperAdmin=correction', _this.form)
                    .then((response) => {
                        _this.$loading(false);
            ...
            totalWeightCalc() {
                ...
                _this.form.total_trans_to_glaze_weight = total_weight;
