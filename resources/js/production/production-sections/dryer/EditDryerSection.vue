                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4">
                        <div class="input-group date">
                            <input type="text" class="form-control form-control-sm m-input datepicker" v-model="form.dryer_date" data-dateField="forming_date" readonly placeholder="Select date from picker" id="m_datepicker_2" autocomplete="off"/>
                        ...
                        <div class ="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(details, index) in form.details">
                                    ...
                                    <td>
                                        <input type="number" step="any" class="form-control form-control-sm m-input width-80" v-model="details.dryer_product_weight" @input="totalWeightCalc()" placeholder="">
                                        <div class="requiredField" v-if="errors['details.'+index+'.dryer_product_weight']">{{ errors['details.'+index+'.dryer_product_weight'][0] }}</div>
                                    </td>
                                    <td>
                                        <input type="number" step="any" class="form-control form-control-sm m-input width-80" v-model="details.current_qty"  @input="totalWeightCalc()" >
                                        <div class="requiredField" v-if="errors['details.'+index+'.current_qty']">{{ errors['details.'+index+'.current_qty'][0] }}</div>
                                    </td>
                                    <td>
                                        <input type="number" step="any" class="form-control form-control-sm m-input width-80" v-model="details.receive_qty" placeholder="" @input="totalWeightCalc()" readonly>
                                        <div class="requiredField" v-if="errors['details.'+index+'.receive_qty']">{{ errors['details.'+index+'.receive_qty'][0] }}</div>
                                    </td>
                                    <td>
                                        <input type="number" step="any" class="form-control form-control-sm m-input width-80" v-model="details.trans_to_glaze_qty" @input="totalWeightCalc()" placeholder="">
                                        <div class="requiredField" v-if="errors['details.'+index+'.trans_to_glaze_qty']">{{ errors['details.'+index+'.trans_to_glaze_qty'][0] }}</div>
                                    </td>
                                    <td>
                                        <input type="number" class="form-control form-control-sm m-input width-80" v-model="details.trans_to_glaze_weight" placeholder="">
                                        <div class="requiredField" v-if="errors['details.'+index+'.trans_to_glaze_weight']">{{ errors['details.'+index+'.trans_to_glaze_weight'][0] }}</div>
                                    </td>

                                    <td>
                                        <input type="number" step="any" class="form-control form-control-sm m-input width-80" v-model="details.glaze_westage_qty" @input="totalWeightCalc()" placeholder="" >
                                        <div class="requiredField" v-if="errors['details.'+index+'.glaze_westage_qty']">{{ errors['details.'+index+'.glaze_westage_qty'][0] }}</div>
                                    </td>
                                    <td>
                                        <input type="number" step="any" class="form-control form-control-sm m-input width-80" v-model="details.glaze_westage_weight" placeholder="" readonly>
                                        <div class="requiredField" v-if="errors['details.'+index+'.glaze_westage_weight']">{{ errors['details.'+index+'.glaze_westage_weight'][0] }}</div>
                                    </td>
                                    <td class="width-160">
                                        <input type="number" step="any" class="form-control form-control-sm m-input width-160" v-model="details.remain_qty" @input="totalWeightCalc()" readonly>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            <button type="submit" v-if="permissions.indexOf('dryer-section.approve') != -1" class="btn btn-sm btn-primary" @click.prevent="update(form.id,1)"><i class="la la-check"></i> <span>Approve</span></button>
        ...
        methods:{
            ...
            update(id,app){
                ...
                _this.form.approve_status = app;
                 _this.$loading(true);
                axios.put(base_url+'dryer-section/'+id, this.form).then( (response) => {
                     _this.$loading(false);
