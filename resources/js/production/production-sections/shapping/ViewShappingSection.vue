                                    ...
                                    <div class="m-invoice__head">
                                        <div class="m-invoice__container m-invoice__container--centered">
                                            <div class="row invoice-header"  style="padding-top: 24px">
                                                <div class="col-md-9">
                                                    <div class="db-data">
                                                        <h1 class="print-head-title">Shaping</h1>
                                                        <p><span style="font-weight: 600">Shaping No :</span> <span>{{ form.shapping_no }}</span></p>
                                                        <p><span style="font-weight: 600">Shaping Date :</span> <span>{{ form.shapping_date }}</span></p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="m-invoice__items">
                                                ...
                                                <div class="m-invoice__item text-center">
                                                    <span class="m-invoice__subtitle">Shaping Date</span>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right m--font-danger">{{ form.total_trans_to_dryer_qty }}</td>
    ...
    export default {
        ...
        methods:{
            ...
            show(id) {
                ...
                axios.get(base_url+'shapping-section/'+id)
                    .then( (response) => {
            ...
            doExportPdf() {
                var _this = this;
                var id = _this.editId;
                window.open(base_url + 'shapping-section?export=pdf&id='+id +'', "_blank");
