...
<script>
    ...
    import AddShappingSection from './AddShappingSection.vue';
    import EditShappingSection from './EditShappingSection.vue';
    import EditCorrectionShappingSection from './EditCorrectionShappingSection.vue';
    import ViewShappingSection from './ViewShappingSection.vue';
    ...
    export default {
        ...
        data: function(){
            return {
                ...
                //VdtnetTable Options
                tableId: 'shapping-section',
                options: {
                    ajax: {
                        url: base_url+"shapping-section",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    id: { label: 'ID'},
                    shapping_no: { label: 'Shaping NO', sortable: true, searchable: true, defaultOrder: 'DESC'  },
                    shapping_date: { label: 'Shaping Date', sortable: true, searchable: true  },
                    ...
                    'production_shappings.created_by': { label: 'User', template: '<span v-if="row.ad_name">Added By : {{ row.ad_name }}</span><br><span v-if="row.ed_name">Edited By  : {{ row.ed_name }}</span><br><span v-if="row.approve_status==1 && row.ap_name">Approved By  : {{ row.ap_name }} </span><br>', sortable: false, searchable: false },
                    ...
                    actions: {
                        ...
                        render: (data,type,row,meta) => {
                            var htmlButtons = '';
                            if (this.permissions.indexOf('shapping-section.edit') != -1 && row.approve_status !=1) {
                            ...
                            if (this.permissions.indexOf('shapping-section.destroy') != -1 && row.approve_status !=1) {
                            ...
                            if (this.permissions.indexOf('shapping-section.show') != -1 ) {
                            ...
                            if ((this.permissions.indexOf('super-admin') != -1 || this.permissions.indexOf('shapping-section.unapprove') != -1) && row.approve_status ==1 ) {
            ...
            deleteData(id,tr){
                ...
                swal({
                    ...
                    function(){
                        ...
                        axios.delete(base_url+'shapping-section/'+id+'/delete').then((response) => {
