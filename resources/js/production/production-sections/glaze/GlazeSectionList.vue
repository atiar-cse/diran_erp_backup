...
<script>
    ...
    import AddGlazeSection from './AddGlazeSection.vue';
    import EditGlazeSection from './EditGlazeSection.vue';
    import EditCorrectionGlazeSection from './EditCorrectionGlazeSection.vue';
    import ViewGlazeSection from './ViewGlazeSection.vue';
    ...
    export default {
        ...
        data: function(){
            return {
                ...
                //VdtnetTable Options
                tableId: 'glaze-section',
                options: {
                    ajax: {
                        url: base_url+"glaze-section",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    id: { label: 'ID'},
                    glaze_no: { label: 'Glaze NO', sortable: true, searchable: true, defaultOrder: 'DESC'  },
                    glaze_date: { label: 'Glaze Date', sortable: true, searchable: true  },
                    ...
                    'production_glazes.created_by': { label: 'User', template: '<span v-if="row.ad_name">Added By : {{ row.ad_name }}</span><br><span v-if="row.ed_name">Edited By  : {{ row.ed_name }}</span><br><span v-if="row.approve_status==1 && row.ap_name">Approved By  : {{ row.ap_name }} </span><br>', sortable: false, searchable: false },
                    ...
                    actions: {
                        ...
                        render: (data,type,row,meta) => {
                            var htmlButtons = '';
                            if (this.permissions.indexOf('glaze-section.edit') != -1 && row.approve_status !=1) {
                            ...
                            if (this.permissions.indexOf('glaze-section.destroy') != -1 && row.approve_status !=1) {
                            ...
                            if (this.permissions.indexOf('glaze-section.show') != -1 ) {
                            ...
                            if ((this.permissions.indexOf('super-admin') != -1 || this.permissions.indexOf('glaze-section.unapprove') != -1) && row.approve_status ==1 ) {
            ...
            deleteData(id,tr){
                ...
                swal({
                    ...
                    function(){
                        ...
                        axios.delete(base_url+'glaze-section/'+id+'/delete').then((response) => {
