                                        ...
                                        <div class="m-invoice__container m-invoice__container--centered">
                                            ...
                                            <div class="m-invoice__items">
                                                <div class="m-invoice__item ">
                                                    <span class="m-invoice__subtitle">Glaze Date</span>
                                                    <span class="m-invoice__text">{{ form.glaze_date }}</span>
                                                </div>
                                                <div class="m-invoice__item text-center">
                                                    <span class="m-invoice__subtitle">Glaze No</span>
                                                    <span class="m-invoice__text">{{ form.glaze_no }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    export default {
        ...
        methods:{
            ...
            show(id) {
                ...
                axios.get(base_url+'glaze-section/'+id)
                    .then( (response) => {
            ...
            doExportPdf() {
                var _this = this;
                var id = _this.editId;
                window.open(base_url + 'glaze-section?export=pdf&id='+id +'', "_blank");
