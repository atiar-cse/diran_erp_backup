                    ...
                    <div class="col-lg-4">
                        <div class="input-group date">
                            <input type="text" class="form-control form-control-sm m-input datepicker"
                                   v-model="form.kiln_date" data-dateField="kiln_date" readonly
                                ...
                                <tr v-for="(details, index) in form.details">
                                    ...
                                    <td class="tdWidth">
                                        <select class="form-control select2 select-product" v-bind:data-index="index"
                                            ...
                                            <option v-for="(value,index) in product_lists"
                                                    :value="value.id"
                                                    :data-kiln-weight="value.kiln_weight"
                                    ...
                                    <td style="width: 160px;">
                                        <input style="width: 160px;" type="number" step="any"
                                               ...
                                               v-model="details.current_qty" placeholder="">
                                    ...
                                    <td style="width: 160px;">
                                        <input style="width: 160px;" type="number" step="any"
                                               ...
                                               @input="totalTransQtyWeightCalc()" readonly>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            <button type="submit" v-if="permissions.indexOf('kiln-section.approve') != -1"
    ...
    export default {
        ...
        methods: {
            ...
            store: function (app) {
                ...
                _this.$loading(true);
                axios.post(base_url + 'kiln-section/store', _this.form)
                    .then((response) => {
                        _this.$loading(false);
            ...
            kilnNoGenerate() {
                var _this = this;
                _this.$loading(true);
                axios.get(base_url + 'kiln-no')
                    .then((response) => {
                        _this.$loading(false);
                        _this.form.kiln_no = response.data;
                    });
            },
        ...
        created() {
            var _this = this;
            _this.totalTransQtyWeightCalc();
            _this.kilnNoGenerate();

            _this.form.kiln_date = moment().format('DD/MM/YYYY');
            setTimeout(function () {
