...
<script>
    ...
    import AddKilnSection from './AddKilnSection.vue';
    import EditKilnSection from './EditKilnSection.vue';
    import EditCorrectionKilnSection from './EditCorrectionKilnSection.vue';
    import ViewKilnSection from './ViewKilnSection.vue';
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                //VdtnetTable Options
                tableId: 'kiln-section',
                options: {
                    ajax: {
                        url: base_url + "kiln-section",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    id: {label: 'ID'},
                    kiln_no: {label: 'Kiln NO', sortable: true, searchable: true, defaultOrder: 'DESC'},
                    kiln_date: {label: 'Kiln Date', sortable: true, searchable: true},
                    ...
                    actions: {
                        ...
                        render: (data, type, row, meta) => {
                            var htmlButtons = '';
                            if (this.permissions.indexOf('kiln-section.edit') != -1 && row.approve_status != 1) {
                            ...
                            if (this.permissions.indexOf('kiln-section.destroy') != -1 && row.approve_status != 1) {
                            ...
                            if (this.permissions.indexOf('kiln-section.show') != -1) {
                            ...
                            if ((this.permissions.indexOf('super-admin') != -1 || this.permissions.indexOf('kiln-section.unapprove') != -1) && row.approve_status ==1 ) {
            ...
            deleteData(id, tr) {
                ...
                swal({
                    ...
                    function () {
                        ...
                        _this.$loading(true);
                        axios.delete(base_url + 'kiln-section/' + id + '/delete')
                            .then((response) => {
                                _this.$loading(false);
