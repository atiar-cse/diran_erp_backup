                                    ...
                                    <div class="m-invoice__head">
                                        <div class="m-invoice__container m-invoice__container--centered">
                                            <div class="row invoice-header" style="padding-top: 24px">
                                                <div class="col-md-9">
                                                    <div class="db-data">
                                                        <h1 class="print-head-title">Finished Stock Section</h1>
                                                        <p><span style="font-weight: 600">No :</span> <span>{{ form.finished_stock_no }}</span>
                                                        </p>
                                                        <p><span style="font-weight: 600">Date :</span> <span>{{ form.date }}</span>
                                                        </p>
                                                    </div>
                                                </div>
    ...
    export default {
        ...
        methods: {
            ...
            show(id) {
                ...
                _this.$loading(true);
                axios.get(base_url + 'finished-stock-section/' + id)
                    .then((response) => {
                        _this.$loading(false);
            ...
            doExportPdf() {
                var _this = this;
                var id = _this.editId;
                window.open(base_url + 'finished-stock-section?export=pdf&id=' + id + '', "_blank");
            },
        },
