<template>
    <div>
        ...
        <AddFinishedStockSection
            v-else-if="add_form"
            :product_lists="product_lists"
            :warehouse_lists="warehouse_lists"
            :permissions="permissions"
        ></AddFinishedStockSection>
        <EditFinishedStockSection
            v-else-if="edit_form"
            :edit-id="edit_id"
            :product_lists="product_lists"
            :warehouse_lists="warehouse_lists"
...
<script>
    ...
    import AddFinishedStockSection from './AddFinishedStockSection.vue';
    import EditFinishedStockSection from './EditFinishedStockSection.vue';
    import ViewFinishedStockSection from './ViewFinishedStockSection.vue';
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                //VdtnetTable Options
                tableId: 'finished-stock-section',
                options: {
                    ajax: {
                        url: base_url + "finished-stock-section",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    ...
                    actions: {
                        ...
                        render: (data, type, row, meta) => {
                            var htmlButtons = '';
                            if (this.permissions.indexOf('finished-stock-section.edit') != -1 && row.approve_status != 1) {
                            ...
                            if (this.permissions.indexOf('finished-stock-section.destroy') != -1 && row.approve_status != 1) {
                            ...
                            if (this.permissions.indexOf('finished-stock-section.show') != -1) {
            ...
            deleteData(id, tr) {
                ...
                swal({
                    ...
                    function () {
                        ...
                        _this.$loading(true);
                        axios.delete(base_url + 'finished-stock-section/' + id + '/delete')
                            .then((response) => {
                                _this.$loading(false);
