        ...
        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="update(form.id)" id="editComponent"
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    ...
                    <label for="m_datepicker_2" class="col-lg-2 col-form-label">Testing/HV Date <span
                        class="requiredField">*</span></label>
                    <div class="col-lg-4">
                                ...
                                <tr v-for="(details, index) in form.details">
                                    ...
                                    <td class="width-160">
                                        <input type="number" step="any"
                                               ...
                                               v-model="details.remain_qty" placeholder="" readonly>
                                    </td>
    ...
    export default {
        ...
        methods: {
            ...
            edit(id) {
                var _this = this;
                _this.$loading(true);
                axios.get(base_url + 'finished-stock-section/' + id + '/edit')
                    .then((response) => {
                        _this.$loading(false);
            ...
            update(id, app) {
                ...
                _this.$loading(true);
                axios.put(base_url + 'finished-stock-section/' + id, _this.form)
                    .then((response) => {
                        _this.$loading(false);
