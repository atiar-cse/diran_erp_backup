<template>
    <div>
        ...
        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="update(form.id)" id="editComponent" class="m-form m-form--fit m-form--label-align-right" >
            ...
            <div class="m-portlet__body">
                ...
                <div v-show="form.packing_types === 'Complete'">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4">
                            <input type="number" step="any" id="trans_to_inventory_store_qty" v-model="form.trans_to_store_qty" @keypress="totalTransQtyPriceCalc()" @input="totalTransQtyPriceCalc()"  class="form-control form-control-sm m-input" placeholder="Enter Store Qty">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4">
                            <input type="number" step="any" id="unit_price" v-model="form.unit_price" @keypress="totalTransQtyPriceCalc()" @input="totalTransQtyPriceCalc()" class="form-control form-control-sm m-input" placeholder="Enter Unit Price" readonly>
            ...
            <div class="m-portlet__body">
                <div class="form-group m-form__group row">
                    <label class="col-lg-6 col-form-label" > <strong>PackedId Materials (Inventory)</strong> </label>
                    <!--
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            <button type="submit" v-if="permissions.indexOf('packing-section.approve') != -1" class="btn btn-sm btn-primary" @click.prevent="update(form.id,1)" ><i class="la la-check"></i> <span>Approve</span></button>
...
<script>
    ...
    export default {
        ...
        props:['permissions','finish_product_lists','editId', 'product_lists', 'warehouse_lists'],
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                _this.$loading(true);
                axios.get(base_url+'packing-section/'+id+'/edit')
                    .then( (response) => {
                        _this.$loading(false);
            ...
            update(id,app){
                ...
                _this.$loading(true);
                axios.put(base_url+'packing-section/'+id, this.form).then( (response) => {
                    _this.$loading(false);
            ...
            loadProductsByWarehouse(){
                ...
                axios.get(base_url+"packing-section/?warehouse_id="+warehouse_id)
                    .then( (response) => {
