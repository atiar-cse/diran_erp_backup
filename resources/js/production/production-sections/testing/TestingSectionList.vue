...
<script>
    ...
    import AddTestingSection from './AddTestingSection.vue';
    import EditTestingSection from './EditTestingSection.vue';
    import ViewTestingSection from './ViewTestingSection.vue';
    ...
    export default {
        ...
        props:['product_lists','permissions','warehouse_lists'],
        ...
        data: function(){
            return {
                ...
                //VdtnetTable Options
                tableId: 'testing-section',
                options: {
                    ajax: {
                        url: base_url+"testing-section",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    ...
                    'production_testings.created_by': { label: 'User', template: '<span v-if="row.ad_name">Added By : {{ row.ad_name }}</span><br><span v-if="row.ed_name">Edited By  : {{ row.ed_name }}</span><br><span v-if="row.approve_status==1 && row.ap_name">Approved By  : {{ row.ap_name }} </span><br>', sortable: false, searchable: false },
                    ...
                    actions: {
                        ...
                        render: (data,type,row,meta) => {
                            var htmlButtons = '';
                            if (this.permissions.indexOf('testing-section.edit') != -1 && row.approve_status !=1) {
                            ...
                            if (this.permissions.indexOf('testing-section.destroy') != -1 && row.approve_status !=1) {
                            ...
                            if (this.permissions.indexOf('testing-section.show') != -1 ) {
            ...
            deleteData(id,tr){
                ...
                swal({
                    ...
                    function(){
                        ...
                        axios.delete(base_url+'testing-section/'+id+'/delete').then((response) => {
