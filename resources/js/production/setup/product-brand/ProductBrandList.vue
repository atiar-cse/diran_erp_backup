        ...
        <div class="m-portlet__body">
            ...
            <!--<table class="table table-bordered table-hover" id="m_table_1">
                ...
                <tr v-for="(value,index) in resultData.data">
                    <td>{{++index}}</td>
                    <td>{{value.product_brand_name}}</td>
...
<script>
    ...
    import AddProductBrand from './AddProductBrand.vue';
    ...
    export default {
        ...
        data: function(){
            return {
                //VdtnetTable Options
                tableId: 'production-brand',
                options: {
                    ajax: {
                        url: base_url+"production-brand",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    ...
                    product_brand_name: { label: 'Product Brand Name', sortable: true, searchable: true, defaultOrder: 'asc'  },
                    ...
                    actions: {
                        ...
                        render: (data) => {
                            var htmlButtons = '';
                            //if (this.permissions.indexOf('production-brand.edit') != -1) {
                            ...
                            // }
                            //if (this.permissions.indexOf('production-brand.destroy') != -1) {
        ...
        methods: {
               /* index(pageNo,perPage){
                    ...
                    axios.get(base_url+"production-brand/?page="+pageNo+"&perPage="+perPage).then((response) => {
                ...
                deleteData(id,tr){
                    ...
                    swal({
                        ...
                        function(){
                            ...
                            axios.delete(base_url+'production-brand/'+id +'/delete').then((response) => {
