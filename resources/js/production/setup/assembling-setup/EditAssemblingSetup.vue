...
<script>
    ...
    export default {
        ...
        props:['permissions','editId','finishing_product_list','fitting_product_list'],
        data:function(){
            return{
                data_list:false,
                add_form:true,
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'assembling-setup/'+id+'/edit')
                    .then( (response) => {
                        _this.form  = response.data.data;
                        //console.log(_this.form.details);
                        setTimeout(function () {
                            var Select2= {
                                init:function() {
                                    $(".select2").select2( {
            ...
            update(id){
                axios.put(base_url+'assembling-setup/'+id, this.form).then( (response) => {
        ...
        mounted(){
            ...
            $('#editComponent').on('change', '.select--fitting-product', function (e) {
                var selectedItem = $(this),
