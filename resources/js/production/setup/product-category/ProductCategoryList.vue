    ...
    export default {
        ...
        data: function(){
            return {
                ...
                //VdtnetTable Options
                tableId: 'production-category',
                options: {
                    ajax: {
                        url: base_url+"production-category",
                        dataSrc: (json) => {
                            return json.data
                        }
                    },
                ...
                fields: {
                    ...
                    product_category_name: { label: 'Category Name', sortable: true, searchable: true, defaultOrder: 'asc'  },
                    ...
                    actions: {
                        ...
                        render: (data) => {
                            var htmlButtons = '';
                            //if (this.permissions.indexOf('production-category.edit') != -1) {
                            ...
                            // }
                            //if (this.permissions.indexOf('production-category.destroy') != -1) {
