                ...
                <div class="row align-items-center">
                    <div class="col-xl-12 order-2 order-xl-1">
                        <div class="form-group m-form__group row align-items-center">
                            ...
                            <div class="col-md-3">
                                <div class="">
                                    <label id="customer_id" class="m-label m-label--single">Customer :</label>
                                    <div class="m-form__control">
                                        <select id="customer_id" class="form-control m-select2 select2" data-selectField="customer_id"  v-model="form.customer_id" >
            ...
            <div class="m-invoice__head print_only">
                <div class="m-invoice__container m-invoice__container--centered">
                    <div class="row invoice-header"  style="padding-top: 0px;padding-bottom:15px;">
                        <div class="col-md-4">
                            <div class="db-data">
                                <p><span style="font-weight: 600">Customer :</span> <span>{{customerName}}</span></p>
...
<script>
    ...
    export default {
        ...
        props:['permissions','customer_lists'],
        ...
        methods: {
            ...
            search:function(){
                ...
                axios.post(base_url+'customer-ledeger-report/customer-index', this.form)
                    .then( (response) => {
        ...
        mounted(){
            ...
            $('#listComponent').on('change', '.select2', function (e) {
                ...
                if(dataIndex == 'customer_id'){
                    _this.form.customer_id = selectedType.val();
                    _this.customerName = $('option:selected', $(e.target)).text();
                }
            });
