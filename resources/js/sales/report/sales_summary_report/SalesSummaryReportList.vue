...
<script>
    ...
    export default {
        ...
        props:['permissions','product_lists','customer_lists'],
        ...
        methods: {
            sales:function(){
                var _this = this;
                axios.post(base_url+'sales-report/sales_summary', this.form)
                    .then( (response) => {
            ...
            doExportPdf() {
                var _this = this;
                window.open(base_url + 'sales-report/sales_summary?export=pdf&customer_id='+_this.form.customer_id +'&product_id='+_this.form.product_id +'&from_date='+ _this.form.from_date +'&end_date='+ _this.form.end_date +'', "_blank");
            },

            doExportExcel() {
                var _this = this;
                window.open(base_url + 'sales-report/sales_summary?export=excel&customer_id=' + _this.form.customer_id + '&product_id=' + _this.form.product_id + '&from_date=' + _this.form.from_date + '&end_date=' + _this.form.end_date + '', "_blank");
            },
