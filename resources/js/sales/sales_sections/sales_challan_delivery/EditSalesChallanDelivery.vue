                        ...
                        <div class ="table-responsive small"  style="font-size: 11px">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(details, index) in form.details">
                                    ...
                                    <td class="width-210">
                                        <select class="form-control m-select2 select2 select-product width-210"  v-bind:data-index="index" v-model="details.sales_delivery_details_product_id"   style="font-size: 11px">
                                    ...
                                    <td>
                                        <input type="text" v-model="details.sales_delivery_details_order_qty"  class="form-control form-control-sm small text-danger"  style="font-size: 11px" readonly>
                                    </td>
                                    <td>
                                        <input type="text" v-model="details.sales_delivery_details_pervious_qty"  class="form-control form-control-sm small text-danger"  style="font-size: 11px" readonly>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" v-model="details.sales_delivery_details_qty" @keyup="totalQtyAndPrice()" class="form-control form-control-sm m-input number width-160" placeholder=""  style="font-size: 11px">
                                    ...
                                    <td class="width-160">
                                        <input type="text" readonly v-model="details.sales_delivery_details_total_price" class="form-control form-control-sm m-input number"  style="font-size: 11px">
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <input type="text" readonly v-model="form.sales_delivery_total_qty" class="form-control form-control-sm m-input number"  style="font-size: 11px">
                                    ...
                                    <td  class="">
                                        <input type="text" readonly v-model="form.sales_delivery_sub_total_price" class="form-control form-control-sm m-input number"  style="font-size: 11px">
                                ...
                                <tr>
                                    ...
                                    <td  class="">
                                        <input type="text" readonly v-model="form.sales_delivery_discount" class="form-control form-control-sm m-input number" @keyup="totalQtyAndPrice()"  style="font-size: 11px">
                                        <div class="requiredField" v-if="(errors.hasOwnProperty('sales_delivery_total_price'))">{{ (errors.hasOwnProperty('sales_delivery_total_price')) ? errors.sales_delivery_total_price[0] :'' }}</div>
                                    </td>
                                    <td></td>
                                </tr>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button v-if="permissions.indexOf('sales-delivery-challan.approve') !=-1" type="submit" class="btn btn-sm btn-success" @click.prevent="update(form.id,1)" ><i class="la la-check"></i> <span>Approve</span></button>

                            <!--<button type="reset" class="btn btn-sm btn-secondary">Cancel</button>
                            <a v-if="permissions.indexOf('sales-delivery-challan.approve') != -1" @click="approve(form.id)" class="btn btn-sm btn-success" ><i class="la la-check"></i> <span>Approve</span></a>
...
<script>
    ...
    export default {
        ...
        props:['editId','permissions','invoice_lists','customer_lists','warehouse_lists'],
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'sales-delivery-challan/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id,app){
                ...
                axios.put(base_url+'sales-delivery-challan/'+id+'/update',
            ...
            approve(id){
                ...
                swal({
                    ...
                    function(){
                        axios.post(base_url + 'sales-delivery-challan/'+id+'/approve').then((response) => {
        ...
        mounted(){
            ...
            $('#editComponent').on('change', '.select-product', function (e) {
                ...
                if(selectStock == null){
                    ...
                    //$('#sales_invoices_warehouse_id').focus();
                    //_this.form.sales_invoices_warehouse_id.focus();
                }
                else{
