                                        ...
                                        <div class="m-invoice__container m-invoice__container--centered">
                                            ...
                                            <div class="m-invoice__items" style="margin-top:-50px;">
                                                <div class="m-invoice__item ">
                                                    <span class="m-invoice__subtitle text-center"><h1>Sales Challan</h1></span>
                                                </div>
                                            </div>

                                            <div class="m-invoice__items" style="margin-top:-100px;">
                                                <div class="m-invoice__item ">
                                                    <span class="m-invoice__subtitle">Voucher No : <span >{{form.sales_invoices_no}}</span></span><br>
                                                </div>
                                                <div class="m-invoice__item">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr v-for="(details, index) in form.details">
                                                        ...
                                                        <td>{{details.sales_invoice_details_remarks}}</td>
                                                        <td>{{details.sales_invoice_details_unit}}</td>
                                                        <td class="m&#45;&#45;font-success">{{details.sales_invoice_details_qty}}</td>
                                                        <td>{{details.sales_invoice_details_unit_price}}</td>
                                                        <td class="m&#45;&#45;font-success">{{details.sales_invoice_details_total_price}}</td>
                                                    </tr>
                                                <tr>
                                                    <td colspan="3" class="text-right text-success">Total Qty</td>
                                                    <td  class="text-right text-success">{{form.sales_invoices_total_qty}}</td>
                                                    <td class="text-right text-success">Total Price</td>
                                                    <td class="text-success">{{form.sales_invoices_total_price}}</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
