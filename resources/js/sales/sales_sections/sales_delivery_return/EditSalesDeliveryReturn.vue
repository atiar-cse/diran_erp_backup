                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4">
                        <div class="input-group date">
                            <input type="text" id="date" class="form-control form-control-sm m-input datepicker" v-model="form.sales_delivery_return_date" data-dateField="sales_delivery_return_date" placeholder="Select date from picker"  />
                            ...
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tbody>
                                    <tr v-for="(details, index) in form.details">
                                        ...
                                        <td>
                                            <input type="text" v-model="details.sales_delivery_return_details_qty" @input="totalQtyAndPrice()" class="form-control form-control-sm m-input number width-160" placeholder="">
                                        ...
                                        <td class="width-160">
                                            <input type="text" v-model="details.sales_delivery_return_details_total_price" class="form-control form-control-sm m-input number">
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button v-if="permissions.indexOf('sales-delivery-return.approve') !=-1" type="submit" class="btn btn-sm btn-success" @click.prevent="update(form.id,1)" ><i class="la la-check"></i> <span>Approve</span></button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        props:['editId','permissions','product_lists','return_type_lists','warehouse_lists','customer_lists'],
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'sales-delivery-return/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id,app){
                ...
                axios.put(base_url+'sales-delivery-return/'+id+'/update',
            ...
            approve(id){
                ...
                swal({
                    ...
                    function(){
                        axios.post(base_url + 'sales-delivery-return/'+id+'/approve').then((response) => {
