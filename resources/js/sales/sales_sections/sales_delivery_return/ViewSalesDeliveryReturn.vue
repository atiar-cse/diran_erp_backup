                                        ...
                                        <div class="m-invoice__container m-invoice__container--centered">
                                            ...
                                            <div class="m-invoice__items" style="margin-top:-50px;">
                                                <div class="m-invoice__item ">
                                                    <span class="m-invoice__subtitle text-center"><h1>Sales Delivery Return</h1></span>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6" align="left">
                                                    <div class="m-invoice__item">
                                                        <span class="m-invoice__subtitle"><b>Voucher No:</b> </span>
                                                        <span class="m-invoice__text" >
                                                        {{ form.sales_delivery_return_no }}
                                                    </span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6" align="right">
                                                    <div class="m-invoice__item">
                                                        <span class="m-invoice__subtitle"><b>Date</b></span>
                                                        <span class="m-invoice__text">{{ form.sales_delivery_return_date }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" align="left">
                                                    <div class="m-invoice__item">
                                                        ...
                                                        <span class="m-invoice__text" ><b>Warehouse: </b> {{ form.sales_delivery_return_warehouse_id }}</span><br>
                                                        <span class="m-invoice__text" ><b>Customer: </b> {{ form.sales_delivery_return_customer_id }}</span><br>
                                                        <span class="m-invoice__text" ><b>Return Type: </b> {{ form.sales_delivery_return_return_types_id }}</span><br>
                                                    </div>
                                                </div>
                                                <br>
                                            </div>
                                    ...
                                    <div class="m-invoice__body m-invoice__body--centered" >
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tr class="medium" v-for="(details, index) in form.details">
                                                    ...
                                                    <td>{{details.sales_delivery_return_details_remarks}}</td>
                                                    <td>{{details.sales_delivery_return_details_unit}}</td>
                                                    <td >{{details.sales_delivery_return_details_qty}}</td>
                                                    <td>{{details.sales_delivery_return_details_unit_price}}</td>
                                                    <td >{{details.sales_delivery_return_details_total_price}}</td>
                                                </tr>

                                                <tr>
                                                    <td colspan="5" align="left">Net Payable Amount</td>
                                                    <td > {{form.sales_delivery_return_total_price}}</td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="description-section">
                                            <p>
                                                ...
                                                <span>{{form.total_pricein_word}} Only.</span>
                                            </p>
                                            <p>
                                                <span style="font-weight: 600">Narration :</span>
                                                <span>{{ form.sales_delivery_return_narration}}</span>
                                            </p>
                                        </div>
    ...
    export default {
        ...
        methods:{
            ...
            show(id) {
                ...
                axios.get(base_url+'sales-delivery-return/'+id)
                    .then( (response) => {
