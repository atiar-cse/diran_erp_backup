        ...
        <form method="POST"  enctype="multipart/form-data" v-on:submit.prevent="update(form.id)" id="editComponent" class="m-form m-form--fit m-form--label-align-right" >
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4">
                        <select class="form-control m-select2 select2  select-supplier" id="po_supplier_id" data-selectField="sindex" v-model="form.po_supplier_id" >
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4">
                        <select class="form-control m-select2 select2 select-requisition" data-selectId="rindex"  v-model="form.po_requisition_id"  @change="loadDetails" >
                        ...
                        <div class ="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(details, index) in form.details">
                                    ...
                                    <td>
                                        <input type="text" v-model="details.pod_total_price" class="form-control form-control-sm m-input">
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <input type="text" v-model="form.po_total_qty" class="form-control form-control-sm m-input">
                                    </td>
                                    <td  class="">
