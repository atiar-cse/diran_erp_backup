                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button  type="submit" v-if="permissions.indexOf('payroll-bonus-summery.approve') !=-1" class="btn btn-sm btn-success" @click.prevent="store(1)"><i class="la la-check"></i> <span>Approve</span></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        methods:{
            ...
            store:function(approval){
                ...
                axios.post(base_url+'payroll-bonus-summery', this.form).then( (response) => {
        ...
        created(){
            ...
            var _this = this;
           _this.calculateTotalBonus();
            _this.form.payroll_bonus_month = moment().format('Y-MM-01');
