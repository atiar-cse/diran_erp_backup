                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button v-if="permissions.indexOf('payroll-salary-summery.approve') !=-1" type="submit" class="btn btn-sm btn-success" @click.prevent="update(form.id,1)"><i class="la la-check"></i> <span>Approve</span></button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            edit(id) {
                var _this = this;
                axios.get(base_url+'payroll-salary-summery/'+id+'/edit')
                    .then( (response) => {
            ...
            update(id,approval){
                ...
                axios.put(base_url+'payroll-salary-summery/'+id, this.form).then( (response) => {
