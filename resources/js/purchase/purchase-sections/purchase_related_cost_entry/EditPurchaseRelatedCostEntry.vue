                        ...
                        <div class ="table-responsive">
                            <table class="table table-sm m-table table-bordered borderless">
                                ...
                                <tr v-for="(details, index) in form.details">
                                    ...
                                    <td>
                                        <input type="text" v-model="details.po_cost_amount"  @input="totalAmount()"  class="form-control form-control-sm m-input">
                                ...
                                <tr>
                                    ...
                                    <td  class="">
                                        <input type="text" v-model="form.po_total_cost" class="form-control form-control-sm m-input" readonly>
                                    </td>
                                    <td></td>
                                </tr>
                                </tbody>
                ...
                <div class="m-form__actions m-form__actions--solid">
                    <div class="row">
                        <div class="col-lg-12 m--align-right">
                            ...
                            <button type="submit" class="btn btn-sm btn-success" @click.prevent="update(form.id,1)"><i class="la la-check"></i> <span>Approve</span></button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        props:['editId','invoice_lists','cost_type_lists','chart_acc_lists'],
        data:function(){
            return{
                product_list:false,
                add_form:false,
        ...
        methods:{
            ...
            edit(id) {
                var _this = this;
                axios.get(base_url+'po-cost-entry/'+id+'/edit')
                    .then( (response) => {
                        _this.form  = response.data.data;
                        setTimeout(function () {
                            _this.initSelect2();
                            _this.loadPurchaseOrderDetails(_this.form.po_order_receive_id);
                        },100);
                    });
            },
            ...
            update(id,app){
                ...
                axios.put(base_url+'po-cost-entry/'+id+'/update',
        ...
        mounted(){
            ...
            $('#editComponent').on('change', '.select-cost-type', function (e) {
