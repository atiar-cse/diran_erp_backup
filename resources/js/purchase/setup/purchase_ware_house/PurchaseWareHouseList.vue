<template>
    <div>
        ...
        <AddPurchaseWareHouse></AddPurchaseWareHouse>
    </div>
</template>
...
<script>
    ...
    import AddPurchaseWareHouse from './AddPurchaseWareHouse.vue';
    import VdtnetTable from 'vue-datatables-net';

    export default {
        components: {
            AddPurchaseWareHouse,
            VdtnetTable
        },
        ...
        data: function(){
            return {
                ...
                fields: {
                    ...
                    purchase_ware_houses_name: { label: 'Ware House Name', sortable: true, searchable: true, defaultOrder: 'asc'  },
                    purchase_ware_houses_contact_person_name: { label: 'Contact Person Name', sortable: true, searchable: true  },
                    purchase_ware_houses_mobile: { label: 'Mobile', sortable: true, searchable: true  },
                    purchase_ware_houses_address: { label: 'Address', sortable: false, searchable: false},
                    ...
                    actions: {
                        ...
                        render: (data) => {
                            var htmlButtons = '';
                            if (this.permissions.indexOf('ware-house.edit') != -1 ) {
                            ...
                            if (this.permissions.indexOf('ware-house.destroy') != -1 ) {
            ...
            deleteData(id,tr){
                ...
                swal({
                    ...
                    function(){
                        ...
                        axios.delete(base_url+'ware-house/'+id+'/delete').then((response) => {
