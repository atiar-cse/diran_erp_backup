@extends('master')
@section('title','Raw Material Ratio Setup')
@section('content')
    <!-- BEGIN: Subheader -->
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/production/raw-material-ratio-setup.js') !!}"></script>
@endpush
