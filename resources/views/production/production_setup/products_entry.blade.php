@extends('master')
@section('title','Manage Product Entry')
@section('content')
    <!-- BEGIN: Subheader -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <product-entry-list
                                ...
                                :brand_list="{{json_encode($brandList)}}"
                                :category_list="{{json_encode($categoryList)}}"
                                :measure_unit_list="{{json_encode($measureUnitList)}}"
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/production/products-entry.js') !!}"></script>
@endpush
