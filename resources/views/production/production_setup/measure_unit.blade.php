@extends('master')
@section('title','Manage Measure Unit')
@section('content')
    <!-- BEGIN: Subheader -->
                            ...
                            <div class="m-portlet__head-tools">
                                <a href="javascript:void(0)"  class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" data-toggle="modal" data-target="#addModel">
                                    <span>
                                        ...
                                        <span>Add Measure Unit</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <measure-unit-list></measure-unit-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
                    <!--end::Portlet-->
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/production/measure-unit.js') !!}"></script>
@endpush
