@extends('master')
@section('title','Manage Production Indirect Costs')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('indirect-costs.store',permissionCheck()))
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Indirect Costs</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <indirect-costs-list
                                ...
                                :indir_costs_types="{{json_encode($indir_costs_types)}}"
                        ></indirect-costs-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/production/indirect-costs.js') !!}"></script>
@endpush
