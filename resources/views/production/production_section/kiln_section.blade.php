@extends('master')
@section('title','Manage Kiln Section')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('kiln-section.store',permissionCheck()))
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/production/kiln-section.js') !!}"></script>
@endpush
