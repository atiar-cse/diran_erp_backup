...
<body>
    ...
    <div style="text-align: center; display: block; margin: 10px 0;">
        <h4 style=" border-bottom: 1px solid #333; padding: 5px 0; width:120px; margin: 0 auto; ">Packing Section</h4>
    </div>
    <br>

    <div style="display: block; width: 100%">
        <div style=" width:60% ; float: left">
            <p> <span class="m-invoice__subtitle">Packing No :</span>{{ $packing['packing_no'] }}</p>
            <p><span class="m-invoice__subtitle">Types :</span>{{ $packing['packing_types'] }}</p>
            <p><span class="m-invoice__subtitle">Date :</span>{{ $packing['packing_date'] }}</p>
            <p><span class="m-invoice__subtitle">Warehouse :</span>{{ $packing['warehouse_id'] }}</p>
        </div>
        <div style=" width:40%; float: right">
            <p> <span class="m-invoice__subtitle">Finish Product :</span>{{ $packing['finishing_product_id'] }}</p>
            <p><span class="m-invoice__subtitle">Store Qty :</span>{{ $packing['trans_to_store_qty'] }}</p>
            <p><span class="m-invoice__subtitle">Unit Price :</span>{{ $packing['unit_price'] }}</p>
            <p><span class="m-invoice__subtitle">Total Price :</span>{{ $packing['total_price'] }}</p>
        </div>
    </div>
    <br/>
    ...
    <table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse; " cellpadding="8">
        ...
        <tbody>
            <!-- ITEMS HERE -->
            @foreach($packing['details'] as $row)
                @php
            ...
            <tr>
                ...
                <td align="center">{{ $row['used_qty'] }}</td>
            ...
            <tr>
                ...
                <td class="text-right m--font-danger">{{ $packing['total_rm_price'] }}</td>
            </tr>
