@extends('master')
@section('title','Manage Packing Section')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('packing-section.store',permissionCheck()))
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Packing Section</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <packing-section-list
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/production/packing-section.js') !!}"></script>
@endpush
