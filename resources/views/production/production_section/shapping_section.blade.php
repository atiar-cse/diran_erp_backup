@extends('master')
@section('title','Manage Shaping Section')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('shapping-section.store',permissionCheck()))
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Shaping Section</span>
                                    </span>
                                </a>
                            </div>
                        </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/production/shapping-section.js') !!}"></script>
@endpush
