@extends('master')
@section('title','Manage Requisition For RM')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('requisition-for-raw-material.store',permissionCheck()))
                                    <a href="javascript:void(0)"  class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" id="addButton">
                                        <span>
                                            ...
                                            <span>Add Requisition for RM</span>
                                        </span>
                                    </a>
                                @endif
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/production/requisition-for-rm.js') !!}"></script>
@endpush
