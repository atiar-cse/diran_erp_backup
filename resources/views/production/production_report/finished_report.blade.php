@extends('master')
@section('title','Finished Stock Report')
@section('content')
    <!-- BEGIN: Subheader -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <finished-report-page></finished-report-page>
                    </div>
                    <!--end::Portlet-->
                </div>
            </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/production/finished-reports.js') !!}"></script>
@endpush
