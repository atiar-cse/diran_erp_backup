@extends('master')
@section('title','Cementing Stock Report')
@section('content')
    <!-- BEGIN: Subheader -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <cementing-report-page></cementing-report-page>
                    </div>
                    <!--end::Portlet-->
                </div>
            </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/production/cementing-reports.js') !!}"></script>
@endpush
