@extends('master')
@section('title','Assembling Report')
@section('content')
    <!-- BEGIN: Subheader -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <assembling-report-page></assembling-report-page>
                    </div>
                    <!--end::Portlet-->
                </div>
            </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/production/assembling-reports.js') !!}"></script>
@endpush
