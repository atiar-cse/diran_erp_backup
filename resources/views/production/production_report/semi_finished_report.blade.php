@extends('master')
@section('title','Semi Finished Report')
@section('content')
    <!-- BEGIN: Subheader -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <semifinished-report-page></semifinished-report-page>
                    </div>
                    <!--end::Portlet-->
                </div>
            </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/production/semi-finished-reports.js') !!}"></script>
@endpush
