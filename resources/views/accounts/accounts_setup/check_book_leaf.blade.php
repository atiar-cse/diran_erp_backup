@extends('master')
@section('title','Manage Cheque Generate')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('check-book-leaf.store',permissionCheck()))
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Cheque Generate</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <check-book-leaf-list
                                :permissions="{{ json_encode(permissionCheck()) }}"
                                :bank_coa_list="{{json_encode($chartofAccountBankWiseList)}}"
                        ></check-book-leaf-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/check-book-leaf.js') !!}"></script>
@endpush
