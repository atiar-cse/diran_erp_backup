                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('bank-account.store',$permissionCheck))
                        ...
                        <bank-account-list
                            ...
                            :chart_lists="{{json_encode($chart_lists)}}"
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/bank-account.js') !!}"></script>
@endpush
