                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('bank.store',$permissionCheck))
                        ...
                        <bank-name-list :permissions="{{ json_encode($permissionCheck) }}" ></bank-name-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
                    <!--end::Portlet-->
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/bank-name.js') !!}"></script>
@endpush
