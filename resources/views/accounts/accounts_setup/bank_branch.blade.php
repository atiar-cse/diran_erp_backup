@extends('master')
@section('title','Manage Bank Branch')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('bank-branch.store',$permissionCheck))
                        ...
                        <bank-branch-list :bank_lists="{{json_encode($bankLists)}}" :permissions="{{ json_encode($permissionCheck) }}" ></bank-branch-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
                    <!--end::Portlet-->
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/bank-branch.js') !!}"></script>
@endpush
