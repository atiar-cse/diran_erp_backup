@extends('master')
@section('title','Manage Cost Centre')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('cost-centre.store',$permissionCheck))
                        ...
                        <cost-centre-list :permissions="{{ json_encode($permissionCheck) }}" ></cost-centre-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
                    <!--end::Portlet-->
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/cost-centre.js') !!}"></script>
@endpush
