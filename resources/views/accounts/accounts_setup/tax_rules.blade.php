@extends('master')
@section('title','Manage Tax Rules')
@section('content')
    <!-- BEGIN: Subheader -->
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/tax-rules.js') !!}"></script>
@endpush
