@extends('master')
@section('title','Manage Fixed Asset Depreciation')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('fixed-asset-depreciation.store',permissionCheck()))
                                    ...
                                    <span>
                                        ...
                                        <span>Add Fixed Asset Depreciation</span>
                                    </span>
                                    </a>
                                @endif
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Fixed Asset Depreciation</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <fixed-asset-depreciation-list
                            ...
                            :sub_code_lists="{{json_encode($subCodeList)}}"
                        ></fixed-asset-depreciation-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/fixed-asset-depreciation.js') !!}"></script>
@endpush
