@extends('master')
@section('title','Manage Contra Entry Voucher')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('contra-entry-voucher.store',permissionCheck()))
                                    ...
                                    <span>
                                        ...
                                        <span>Add Contra Entry Voucher</span>
                                    </span>
                                    </a>
                                @endif
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Contra Entry Voucher</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <contra-entry-voucher-list
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/contra-entry-voucher.js') !!}"></script>
@endpush
