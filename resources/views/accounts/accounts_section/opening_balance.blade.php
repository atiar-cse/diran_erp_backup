@extends('master')
@section('title','Manage Opening Balance')
@section('content')
    <!-- BEGIN: Subheader -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Opening Balance</span>
                                    </span>
                                </a>
                            </div>
                            @php
                        ...
                        <opening-balance-list
                            ...
                            :main_lists="{{json_encode($mainLists)}}"
                            :acc_chart_lists="{{json_encode($chartAcLists)}}"
                        ></opening-balance-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/opening-balance.js') !!}"></script>
@endpush
