@extends('master')
@section('title','Manage Bank Transfer/Deposit')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('bank-transfer-deposit.store',permissionCheck()))
                                    ...
                                    <span>
                                        ...
                                        <span>Add Bank Transfer/Deposit</span>
                                    </span>
                                    </a>
                                @endif
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Bank Transfer/Deposit</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <bank-transfer-deposit-list
                                ...
                                :bank_list="{{json_encode($bankList)}}"
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/bank-transfer-deposit.js') !!}"></script>
@endpush
