@extends('master')
@section('title','Manage Purchase Return Voucher')
@section('content')
    <!-- BEGIN: Subheader -->
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        ...
                                        <span>Manage Purchase Return Voucher</span>
                                    </span>
                                </a>
                            </div>
                        </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/purchase-return-voucher.js') !!}"></script>
@endpush
