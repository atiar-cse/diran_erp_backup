@extends('master')
@section('title','Manage Cash Receipt ')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('cash-receipt-voucher.store',permissionCheck()))
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/cash-receipt-voucher.js') !!}"></script>
@endpush
