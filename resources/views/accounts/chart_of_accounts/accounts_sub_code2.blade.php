@extends('master')
@section('title','Manage Accounts Sub Code2')
@section('content')
    <!-- BEGIN: Subheader -->
                            ...
                            <div class="m-portlet__head-tools">
                                <a href="javascript:void(0)"  class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" data-toggle="modal" data-target="#addModel">
                                    <span>
                                        ...
                                        <span>Add Accounts Sub Code2</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <account-sub-code2-list
                                :permissions="{{ json_encode(permissionCheck()) }}"
                                :sub_code_list="{{json_encode($subCodeList)}}"
                        ></account-sub-code2-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/account-sub-code2.js') !!}"></script>
@endpush
