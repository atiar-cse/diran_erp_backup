@extends('master')
@section('title','Manage Accounts Sub Code')
@section('content')
    <!-- BEGIN: Subheader -->
                            ...
                            <div class="m-portlet__head-tools">
                                <a href="javascript:void(0)"  class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" data-toggle="modal" data-target="#addModel">
                                    <span>
                                        ...
                                        <span>Add Accounts Sub Code</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <account-sub-code-list
                                :permissions="{{ json_encode(permissionCheck()) }}"
                                :accounts_main_code_list="{{json_encode($accountMainCodeList)}}"
                        ></account-sub-code-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/account-sub-code.js') !!}"></script>
@endpush
