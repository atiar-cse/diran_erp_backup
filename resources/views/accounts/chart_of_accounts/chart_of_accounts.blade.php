            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                                <span class="m-nav__link-text">Chart Of Accounts</span>
                            </a>
                        </li>
                        <li class="m-nav__separator">-</li>
                        <li class="m-nav__item">
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('chart-of-accounts.store',permissionCheck()))
                                    ...
                                    <span>
                                        ...
                                        <span>Add Chart Of Accounts</span>
                                    </span>
                                    </a>
                                @endif
                                ...
                                <a  href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air"  id="printButton">
                                <span>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/chart-of-accounts.js') !!}"></script>
@endpush
