@extends('master')
@section('title','Manage LC Other Charge Entry ')
@section('content')
    <!-- BEGIN: Subheader -->
                            ...
                            <div class="m-portlet__head-tools">
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        ...
                                        <span>Manage LC Other Charge Entry</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <acc-others-charge-entry-list
                                :permissions="{{ json_encode(permissionCheck()) }}"
                                :lc_lists="{{json_encode($lcLists)}}"
                                :lc_cost_name_category_list="{{json_encode($lcCostNameCategoryList)}}"
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/acc-others-charge-entry.js') !!}"></script>
@endpush
