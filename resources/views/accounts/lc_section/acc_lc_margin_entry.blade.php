@extends('master')
@section('title','Manage LC (PI) Margin Entry')
@section('content')
    <!-- BEGIN: Subheader -->
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        ...
                                        <span>Manage LC Margin Entry</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <acc-lc-cf-value-margin-entry-list
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/acc-lc-cf-value-margin-entry.js') !!}"></script>
@endpush
