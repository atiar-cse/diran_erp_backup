@extends('master')
@section('title','Manage LC Opening Section')
@section('content')
    <!-- BEGIN: Subheader -->
                            ...
                            <div class="m-portlet__head-tools">
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        ...
                                        <span>Manage LC Opening Section</span>
                                    </span>
                                </a>
                            </div>
                        </div>

                        <acc-lc-opening-section-list
                                :permissions="{{ json_encode(permissionCheck()) }}"
                                :pi_invoice_lists="{{json_encode($piInvoiceLists)}}"
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/acc-lc-opening-section.js') !!}"></script>
@endpush
