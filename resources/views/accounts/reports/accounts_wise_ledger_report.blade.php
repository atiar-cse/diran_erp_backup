@extends('master')
@section('title','Account Wise Ledger Report')
@section('content')
    <!-- BEGIN: Subheader -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <account-wise-ledger-report-page></account-wise-ledger-report-page>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
                    <!--end::Portlet-->
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/account-wise-ledger-reports.js') !!}"></script>
@endpush
