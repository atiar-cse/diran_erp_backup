@extends('master')
@section('title','Loss & Profit Statements')
@section('content')
    <!-- BEGIN: Subheader -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <loss-profit-report-page></loss-profit-report-page>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
                    <!--end::Portlet-->
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/loss-profit-reports.js') !!}"></script>
@endpush
