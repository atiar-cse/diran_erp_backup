@extends('master')
@section('title','Daily Statements Report')
@section('content')
    <!-- BEGIN: Subheader -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <daily-statement-page></daily-statement-page>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
                    <!--end::Portlet-->
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/daily-statement-reports.js') !!}"></script>
@endpush
