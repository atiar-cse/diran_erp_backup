@extends('master')
@section('title','Sub Code 2 Wise Trial Balance ')
@section('content')
    <!-- BEGIN: Subheader -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <trial-balance-sub2-page></trial-balance-sub2-page>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
                    <!--end::Portlet-->
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/trial-balance-reports-sub2.js') !!}"></script>
@endpush
