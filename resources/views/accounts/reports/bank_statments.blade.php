@extends('master')
@section('title','Bank Statements Report')
@section('content')
    <!-- BEGIN: Subheader -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <bank-statement-page
                            :bank_coa_list="{{json_encode($bank_coa_list)}}"
                        ></bank-statement-page>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/account/bank-statement-reports.js') !!}"></script>
@endpush
