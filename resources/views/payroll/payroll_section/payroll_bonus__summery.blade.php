@extends('master')
@section('title','Payroll Bonus Summary')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('payroll-bonus-summery.store',permissionCheck()))
                                    ...
                                    <span>
                                        ...
                                        <span>Add Payroll Bonus Summary </span>
                                    </span>
                                    </a>
                                @endif
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Payroll Bonus Summary </span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <payroll-bonus-summery-list
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/payroll/payroll-bonus-summery.js') !!}"></script>
@endpush
