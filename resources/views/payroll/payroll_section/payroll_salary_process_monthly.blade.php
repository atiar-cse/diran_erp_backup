@extends('master')
@section('title','Payroll Salary Summary Monthly')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                             ...
                             @if (in_array('payroll-salary-summery.store',permissionCheck()))
                                    ...
                                    <span>
                                        ...
                                        <span>Add Payroll Salary Summary Monthly</span>
                                    </span>
                                    </a>
                                @endif
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Payroll Salary Summary Monthly</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <payroll-salary-process-monthly-list
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/payroll/payroll-salary-process-monthly.js') !!}"></script>
@endpush
