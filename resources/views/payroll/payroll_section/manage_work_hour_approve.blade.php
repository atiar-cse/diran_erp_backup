@extends('master')
@section('title','Manage Employee Working Hour')
@section('content')
    <!-- BEGIN: Subheader -->
            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                                <span class="m-nav__link-text">Employee Working Hour</span>
                            </a>
                        </li>
                        <li class="m-nav__separator">-</li>
                        <li class="m-nav__item">
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/payroll/manage-work-hour-approve.js') !!}"></script>
@endpush
