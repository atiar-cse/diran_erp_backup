@extends('master')
@section('title','Manage Pay Grade')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('monthly-pay-grade.store',permissionCheck()))
                        ...
                        <monthly-pay-grade-list
                                ...
                                :allowance_lists="{{ json_encode($allowanceList) }}"
                                :deduction_lists="{{ json_encode($deductionList) }}"
                        ></monthly-pay-grade-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/payroll/monthly-pay-grade.js') !!}"></script>
@endpush
