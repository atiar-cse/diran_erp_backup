@extends('master')
@section('title','Manage Sales Delivery Return')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('sales-delivery-return.store',$permissionCheck))
                                    <a href="javascript:void(0)"  class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" id="addButton">
                                        <span>
                                            ...
                                            <span>Add Sales Delivery Return </span>
                                        </span>
                                    </a>
                                @endif
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Sales Delivery Return</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <sales-delivery-return-list
                            :permissions="{{ json_encode($permissionCheck) }}"
                            :product_lists="{{json_encode($productLists)}}"
                            :return_type_lists="{{json_encode($returntypeLists)}}"
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/sales/sales-delivery-return.js') !!}"></script>
@endpush
