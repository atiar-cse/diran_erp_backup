@extends('master')
@section('title','Manage Sales Invoice')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('sales-delivery-challan.store',$permissionCheck))
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Sales Invoice </span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <sales-challan-delivery-list
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/sales/sales-challan-delivery.js') !!}"></script>
@endpush
