@extends('master')
@section('title','Manage Sales Customer')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('customer.store',$permissionCheck))
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/sales/sales-customer.js') !!}"></script>
@endpush
