@extends('master')
@section('title','Inventory Ledger Report')
@section('content')
    <!-- BEGIN: Subheader -->
            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                                <span class="m-nav__link-text">Sales Price Report</span>
                            </a>
                        </li>
                        <li class="m-nav__separator">-</li>
                        <li class="m-nav__item">
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/inventory/sales-price-report.js') !!}"></script>
@endpush
