@extends('master')
@section('title','Manage Stock Adjust')
@section('content')
    <!-- BEGIN: Subheader -->
            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                                <span class="m-nav__link-text">Stock Adjust</span>
                            </a>
                        </li>
                        <li class="m-nav__separator">-</li>
                        <li class="m-nav__item">
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('stock-adjust.store',$permissionCheck))
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/inventory/inventory-stock-adjust.js') !!}"></script>
@endpush
