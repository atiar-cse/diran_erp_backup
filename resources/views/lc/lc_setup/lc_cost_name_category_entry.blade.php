@extends('master')
@section('title','Manage LC Cost Category')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('lc-cost-name-category-entry.create',permissionCheck()))
                                <a href="javascript:void(0)"  class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" data-toggle="modal" data-target="#addModel">
                                    <span>
                                        ...
                                        <span>Add LC Cost Category</span>
                                    </span>
                                </a>
                                @endif
                            </div>
                        </div>
                        <lc-cost-name-category-entry-list 
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/lc/lc-cost-name-category-entry.js') !!}"></script>
@endpush
