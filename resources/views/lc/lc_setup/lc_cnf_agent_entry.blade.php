@extends('master')
@section('title','Manage LC C&F Agent / Party')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('lc-cnf-agent-entry.create',permissionCheck()))
                                <a href="javascript:void(0)"  class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" data-toggle="modal" data-target="#addModel">
                                    <span>
                                        ...
                                        <span>Add LC C&F Agent / Party</span>
                                    </span>
                                </a>                                   
                                @endif
                            </div>
                        </div>
                        <lc-cnf-agent-entry-list 
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/lc/lc-cnf-agent-entry.js') !!}"></script>
@endpush
