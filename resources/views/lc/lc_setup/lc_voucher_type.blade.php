@extends('master')
@section('title','Manage LC Voucher Type')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('lc-voucher-type.create',permissionCheck()))
                                    ...
                                    <span>
                                        ...
                                        <span>Add LC Voucher Type</span>
                                    </span>
                                    </a>
                                @endif
                            </div>
                        </div>
                        <lc-voucher-type-list
...
@push('custom_scripts')
    <script type="text/javascript" src="{!! asset('js/lc/lc-voucher-type.js') !!}"></script>
@endpush
