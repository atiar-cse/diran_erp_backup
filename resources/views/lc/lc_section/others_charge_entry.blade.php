                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('others-charge-entry.create',permissionCheck()))
                                <a href="javascript:void(0)"  class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" id="addButton">
                                    <span>
                                        ...
                                        <span>Add LC Other Charge Entry </span>
                                    </span>
                                </a>
                                @endif
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/lc/others-charge-entry.js') !!}"></script>
@endpush
