                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('lc-cf-value-margin-entry.create',permissionCheck()))
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/lc/lc-cf-value-margin-entry.js') !!}"></script>
@endpush
