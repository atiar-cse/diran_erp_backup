@extends('master')
@section('title','Manage Proforma Invoice ')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('proforma-invoice-entry.create',permissionCheck()))
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Proforma Invoice</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <proforma-invoice-entry-list
                                ...
                                :cuountry_lists="{{json_encode($countryLists)}}"
                        ></proforma-invoice-entry-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/lc/proforma-invoice-entry.js') !!}"></script>
@endpush
