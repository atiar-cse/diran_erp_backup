                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('lc-opening-section.create',permissionCheck()))
                                    ...
                                    <span>
                                        ...
                                        <span>Add LC Opening Section</span>
                                    </span>
                                    </a>
                                @endif
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/lc/lc-opening-section.js') !!}"></script>
@endpush
