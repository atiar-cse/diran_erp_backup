                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('custom-duty-charge-entry.create',permissionCheck()))
                                <a href="javascript:void(0)"  class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" id="addButton">
                                    <span>
                                        ...
                                        <span>Add Custom Duty Charge Entry </span>
                                    </span>
                                </a>
                                @endif
                        ...
                        <custom-duty-charge-entry-list
                                ...
                                :cnf_agent_list="{{json_encode($cnf_agent_list)}}"
                        ></custom-duty-charge-entry-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/lc/custom-duty-charge-entry.js') !!}"></script>
@endpush
