@extends('master')
@section('title','Manage LC Closing')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('lc-closing.create',permissionCheck()))
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/lc/lc-closing.js') !!}"></script>
@endpush
