@extends('master')
@section('title','LC CI Landed Cost')
@section('content')
    <!-- BEGIN: Subheader -->
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none;" id="listButton">
                                    <span>
                                        ...
                                        <span>LC CI Landed Cost</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <lc-ci-landed-cost-list 
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/lc/lc-ci-landed-cost.js') !!}"></script>
@endpush
