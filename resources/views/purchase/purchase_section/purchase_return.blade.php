@extends('master')
@section('title','Manage Purchase Return')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('po-return.store',$permissionCheck))
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Purchase Return</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <purchase-return-list
                            ...
                            :issue_type_lists="{{json_encode($issueTypeLists)}}"
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/purchase/purchase-return.js') !!}"></script>
@endpush
