@extends('master')
@section('title','Manage Purchase Requisition')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('pr-requisition.store',$permissionCheck))
                                    <a href="javascript:void(0)"  class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" id="addButton">
                                        <span>
                                            ...
                                            <span>Add Purchase Requisition </span>
                                        </span>
                                    </a>
                                @endif
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/purchase/purchase-requisition.js') !!}"></script>
@endpush
