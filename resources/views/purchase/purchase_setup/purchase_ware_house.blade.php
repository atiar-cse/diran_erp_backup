                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('ware-house.store',$permissionCheck))
                        ...
                        <purchase-ware-house-list :permissions="{{ json_encode($permissionCheck) }}"></purchase-ware-house-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
                    <!--end::Portlet-->
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/purchase/purchase-ware-house.js') !!}"></script>
@endpush
