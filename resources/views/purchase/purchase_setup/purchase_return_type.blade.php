@extends('master')
@section('title','Manage Inventory Return Type')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('return-type.store',$permissionCheck))
                        ...
                        <purchase-return-type-list :permissions="{{ json_encode($permissionCheck) }}"></purchase-return-type-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
                    <!--end::Portlet-->
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/purchase/purchase-return-type.js') !!}"></script>
@endpush
