@extends('master')
@section('title','Manage Purchase Supplier')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('supplier-entry.store',$permissionCheck))
                                    ...
                                    <a href="javascript:void(0)"  class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" data-toggle="modal" data-target="#addModel">
                                        <span>
                                            <i class="fa fa-list"></i>
                                            <span>Add Purchase Supplier</span>
                                        </span>
                                    </a>
                                @endif
                        ...
                        <purchase-supplier-list
                            ...
                            :chat_lists="{{ json_encode($chat_lists) }}"
                        ></purchase-supplier-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/purchase/purchase-supplier.js') !!}"></script>
@endpush
