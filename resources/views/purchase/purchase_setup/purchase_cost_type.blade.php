@extends('master')
@section('title','Manage Purchase Cost Type')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('cost-type.store',$permissionCheck))
                                    <a href="javascript:void(0)"  class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" data-toggle="modal" data-target="#addModel">
                                        <span>
                                            ...
                                            <span>Add Purchase Cost Type</span>
                                        </span>
                                    </a>
                                @endif
                            </div>
                        </div>
                        <purchase-cost-type-list
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/purchase/purchase-cost-type.js') !!}"></script>
@endpush
