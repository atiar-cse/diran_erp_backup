@extends('master')
@section('title','Manage Purchase Report')
@section('content')
    <!-- BEGIN: Subheader -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <purchase-report-list
                            ...
                            :pur_stock_lists="{{ json_encode($purStockLists) }}"
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/purchase/purchase-report.js') !!}"></script>
@endpush
