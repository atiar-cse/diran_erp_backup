@extends('master')
@section('title','Manage Purchase Return Report')
@section('content')
    <!-- BEGIN: Subheader -->
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        ...
                                        <span>Manage Purchase report</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <purchase-return-report-list
                            :permissions="{{ json_encode($permissionCheck) }}"
                            :return_lists="{{ json_encode($returnLists) }}"
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/purchase/purchase-return-report.js') !!}"></script>
@endpush
