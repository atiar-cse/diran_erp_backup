                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                  @if (in_array('warning.store',permissionCheck()))
                        ...
                        <warning-list
                                ...
                                :employee_list="{{json_encode($employeeList)}}"
                        ></warning-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/hr/warning.js') !!}"></script>
@endpush
