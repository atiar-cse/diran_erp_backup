@extends('master')
@section('title','Manage Employee Promotion')
@section('content')
    <!-- BEGIN: Subheader -->
                            ...
                            <div class="m-portlet__head-tools">
                                {{--@if (in_array('production-entry.store',permissionCheck()))--}}
                                    ...
                                    <span>
                                        ...
                                        <span>Add Employee Promotion</span>
                                    </span>
                                    </a>
                              {{--  @endif--}}
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Employee Promotion</span>
                                    </span>
                                </a>
                            </div>
                        </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/hr/promotion.js') !!}" ></script>
@endpush
