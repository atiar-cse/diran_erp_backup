                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                @if (in_array('division.store',$permissionCheck))
                        ...
                        <division-list
                                ...
                                :head_person_lists ="{{json_encode($headPersonList)}}"
                                :unit_lists="{{json_encode($unitList)}}"
                        ></division-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/hr/division.js') !!}"></script>
@endpush
