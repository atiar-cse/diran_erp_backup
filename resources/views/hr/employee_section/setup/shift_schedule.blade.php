@extends('master')
@section('title','Manage Shift Schedule')
@section('content')
    <!-- BEGIN: Subheader -->
                        ...
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                <a href="javascript:history.back();"
                                   class="btn btn-sm btn-secondary m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m--visible-desktop-inline-block">
                                    <span>
                                ...
                                <a href="javascript:void(0)"
                                   class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air"
                                   style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Shift Schedule</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <shift-schedule-list></shift-schedule-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
                    <!--end::Portlet-->
...
@push('custom_scripts')
    <script type="text/javascript" src="{!! asset('js/hr/shift-schedule.js') !!}"></script>
@endpush
