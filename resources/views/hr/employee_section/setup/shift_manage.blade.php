                ...
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <shift-manage-list
                            ...
                            :shift_schedule_list="{{ json_encode($shift_schedule_list) }}"
                        ></shift-manage-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
    <script type="text/javascript" src="{!! asset('js/hr/shift-manage.js') !!}"></script>
@endpush
<script>
    import ShiftManageList from "../../../../js/hr/employee-section/shift-manage/ShiftManageList";

    export default {
        components: {ShiftManageList}
    }
</script>
