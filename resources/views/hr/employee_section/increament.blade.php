@extends('master')
@section('title','Manage Employee Increament')
@section('content')
    <!-- BEGIN: Subheader -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                            ...
                            <div class="m-portlet__head-tools">
                                {{--@if (in_array('production-entry.store',permissionCheck()))--}}
                                    ...
                                    <span>
                                        ...
                                        <span>Add Employee Increament</span>
                                    </span>
                                    </a>
                              {{--  @endif--}}
                                <a href="javascript:void(0)" class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" style="display: none" id="listButton">
                                    <span>
                                        <i class="fa fa-list"></i>
                                        <span>Manage Employee Increament</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <increament-list
                                ...
                                :employee_lists="{{json_encode($employeeLists)}}"
                                :paygrade_lists="{{json_encode($payGradeLists)}}"
                                :department_lists="{{json_encode($departmentLists)}}"
                                :designation_lists="{{json_encode($designationLists)}}"
                        ></increament-list>
                        <!--begin::Form-->
                        <!--end::Form-->
                    </div>
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/hr/increament.js') !!}"></script>
@endpush
