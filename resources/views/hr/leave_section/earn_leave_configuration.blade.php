@extends('master')
@section('title','Manage Rules Of Earn Leave')
@section('content')
    <!-- BEGIN: Subheader -->
                            ...
                            <div class="m-portlet__head-tools">
                                <a href="javascript:void(0)"  class="btn btn-sm btn-brand m-btn--icon m-btn--wide m-btn--sm m--margin-right-10 m-btn--air" data-toggle="modal" data-target="#addModel">
                                    <span>
                                        ...
                                        <span>Add Rules Of Earn Leave</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <earn-leave-configuration-list
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/hr/earn-leave-configuration.js') !!}"></script>
@endpush
