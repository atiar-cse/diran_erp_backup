@extends('master')
@section('title','Manage Weekly Holiday')
@section('content')
    <!-- BEGIN: Subheader -->
                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__head">
                            ...
                            <div class="m-portlet__head-tools">
                                ...
                                @if (in_array('weekly-holiday.store',permissionCheck()))
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/hr/weekly-holiday.js') !!}"></script>
@endpush
