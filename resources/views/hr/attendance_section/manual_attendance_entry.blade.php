@extends('master')
@section('title','Manage Employee Attendance')
@section('content')
    <!-- BEGIN: Subheader -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <manual-attendance-entry-list
                                :department_lists="{{json_encode($departmentLists)}}"
                                :work_shift_list="{{json_encode($workShiftLists)}}"
...
@push('custom_scripts')
<script type="text/javascript" src="{!! asset('js/hr/manual-attendance-entry.js') !!}"></script>
@endpush
